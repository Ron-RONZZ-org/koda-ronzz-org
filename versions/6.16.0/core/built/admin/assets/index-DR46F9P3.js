...
`,ct=Object.freeze(Object.defineProperty({__proto__:null,default:dt},Symbol.toStringTag,{value:"Module"})),st=`.kg-toggle-card,
.kg-toggle-card * {
    box-sizing: border-box;
}
...
`,lt=Object.freeze(Object.defineProperty({__proto__:null,default:st},Symbol.toStringTag,{value:"Module"})),gt=`.kg-video-card,
.kg-video-card * {
    box-sizing: border-box;
}
...
`,pt=Object.freeze(Object.defineProperty({__proto__:null,default:gt},Symbol.toStringTag,{value:"Module"})),ut=Object.assign({"../../ghost/core/core/frontend/src/cards/js/audio.js":_e,"../../ghost/core/core/frontend/src/cards/js/gallery.js":Ie,"../../ghost/core/core/frontend/src/cards/js/toggle.js":Fe,"../../ghost/core/core/frontend/src/cards/js/video.js":Re}),ht=Object.assign({"../../ghost/core/core/frontend/src/cards/css/audio.css":Te,"../../ghost/core/core/frontend/src/cards/css/blockquote.css":Ae,"../../ghost/core/core/frontend/src/cards/css/bookmark.css":De,"../../ghost/core/core/frontend/src/cards/css/button.css":qe,"../../ghost/core/core/frontend/src/cards/css/callout.css":Ue,"../../ghost/core/core/frontend/src/cards/css/collection.css":Ke,"../../ghost/core/core/frontend/src/cards/css/cta.css":Ye,"../../ghost/core/core/frontend/src/cards/css/file.css":Ze,"../../ghost/core/core/frontend/src/cards/css/gallery.css":Xe,"../../ghost/core/core/frontend/src/cards/css/header.css":nt,"../../ghost/core/core/frontend/src/cards/css/header_v2.css":tt,"../../ghost/core/core/frontend/src/cards/css/nft.css":ot,"../../ghost/core/core/frontend/src/cards/css/product.css":it,"../../ghost/core/core/frontend/src/cards/css/signup.css":ct,"../../ghost/core/core/frontend/src/cards/css/toggle.css":lt,"../../ghost/core/core/frontend/src/cards/css/video.css":pt}),mt=Object.values(ut).map(a=>a.default).join(`

`),kt=Object.values(ht).map(a=>a.default).join(`

`),ft=({postUrl:a,heading:s,image:t,excerpt:p,authors:c,html:k,backgroundColor:i,fontSize:u,fontStyle:v,onHeadingsExtracted:h,onIframeLoad:r,onLoadingChange:l,isPopoverOpen:d})=>{const _=o.useRef(null),[F,D]=o.useState(!0),[L,S]=o.useState("0px"),M=document.documentElement.classList.contains("dark")&&i==="SYSTEM"||i==="DARK",W=ze(),f=`
        ...
        <body>
            <header class='gh-article-header gh-canvas'>
                <h1 class='gh-article-title is-title' data-test-article-heading>${s}</h1>
                    ...
                    <div class="gh-article-meta-wrapper">
                        ${c&&c.length>0?`
                            <span class="gh-article-author-name">
                                ${c.length>1?`${c[0].name} and ${c.length-1} ${c.length-1===1?"other":"others"}`:c[0].name}
                            </span>
                        `:""}
    ...
    `;return o.useEffect(()=>{const g=_.current;if(!g)return;g.srcdoc||(g.srcdoc=f);const R=b=>{if(b.data.type==="resize"){const N=`${b.data.bodyHeight+24}px`;S(N),g.style.height=N,b.data.isLoaded&&D(!1)}},j=b=>{if(b.key==="Escape"){b.preventDefault(),b.stopPropagation();const N=new KeyboardEvent("keydown",{key:"Escape",code:"Escape",keyCode:27,which:27,bubbles:!0,cancelable:!0});document.dispatchEvent(N)}},z=()=>{const b=g.contentWindow;b&&b.addEventListener("keydown",j)};return g.addEventListener("load",z),window.addEventListener("message",R),()=>{window.removeEventListener("message",R),g.removeEventListener("load",z);const b=g.contentWindow;b&&b.removeEventListener("keydown",j)}},[f]),o.useEffect(()=>{const g=_.current;if(!g)return;const R=g.contentDocument||g.contentWindow?.document;if(!R)return;const j=R.documentElement;j.style.setProperty("--font-size",u),j.classList.remove("has-sans-body","has-serif-body"),j.classList.add(`has-${v}-body`),j.classList.remove("has-dark-text","has-light-text"),j.classList.add(`has-${M?"light":"dark"}-text`),i==="SEPIA"?j.classList.add("has-sepia-bg"):j.classList.remove("has-sepia-bg");const z=g.contentWindow;if(z&&typeof z.resizeIframe=="function")z.resizeIframe();else{const b=new Event("resize");R.dispatchEvent(b)}},[u,v,i,M]),o.useEffect(()=>{const g=_.current;if(!g)return;const R=()=>{if(!g.contentDocument)return;const j=Array.from(g.contentDocument.querySelectorAll(".gh-content > :is(h2, h3, h4, h5, h6)[id]"));if(j.length===0)return;const z=Math.min(...j.map(N=>parseInt(N.tagName[1]))),b=j.map((N,Q)=>{const O=`heading-${Q}`;N.id=O;const Z=parseInt(N.tagName[1])-z+1;return{id:O,text:N.textContent||"",level:Z,element:N}});h?.(b),r?.(g)};return g.addEventListener("load",R),()=>g.removeEventListener("load",R)},[h,r]),o.useEffect(()=>{l?.(F)},[F,l]),n.jsx("div",{className:"w-full pb-6",children:n.jsxs("div",{className:"relative -mx-6",children:[F&&n.jsxs("div",{className:"mx-auto mt-6 w-full max-w-[640px] max-lg:px-4",children:[n.jsxs("div",{className:"mb-6 flex flex-col gap-2",children:[n.jsx(E,{className:"h-8"}),n.jsx(E,{className:"h-8 w-full max-w-md"})]}),n.jsx(E,{className:"mt-2 h-4",count:4,randomize:!0}),n.jsx(E,{className:"mt-8 h-[400px]"}),n.jsx(E,{className:"mt-2 h-4",containerClassName:"block mt-7 mb-4",count:8,randomize:!0})]}),n.jsx("iframe",{ref:_,id:"gh-ap-article-iframe",style:{width:"100%",border:"none",height:L,overflow:"hidden",opacity:F?0:1,transition:"opacity 0.2s ease-in-out",pointerEvents:d?"none":"auto"},title:"Embedded Content"})]})})},jn=()=>n.jsx("div",{className:"h-px bg-black/[8%] dark:bg-gray-950"}),Y=new Map,bt=({postId:a=null,onClose:s})=>{const{backgroundColor:t,currentFontSizeIndex:p,fontStyle:c,fontSize:k,handleColorChange:i,setFontStyle:u,increaseFontSize:v,decreaseFontSize:h,resetFontSize:r}=ve(),l=o.useRef(null),[d,_]=o.useState(!1),[F,D]=o.useState(!1),[L,S]=o.useState(new Set),[M,W]=o.useState(new Set),[f,g]=o.useState(new Set),[R,j]=o.useState(!1),z=o.useRef(null),b=o.useRef(null),{post:N,processedReplies:Q,isLoading:O,loadMoreChildren:dn,loadMoreChildReplies:Z,hasMoreChildren:J,hasMoreChildReplies:X}=ke(a??"",{includeAncestors:!1}),cn=N,x=cn?.object,B=cn?.actor,_n=cn?.object?.metadata?.ghostAuthors,Nn=x?.replyCount??0;o.useEffect(()=>{if(!J)return;z.current&&z.current.disconnect();const e=l.current;if(e)return z.current=new IntersectionObserver(async w=>{if(w[0].isIntersecting&&J&&!R){j(!0);try{await dn()}catch(m){console.error("Failed to load more top-level replies:",m)}finally{j(!1)}}},{root:e,rootMargin:"200px"}),b.current&&z.current.observe(b.current),()=>{z.current&&z.current.disconnect()}},[J,R,dn]);function sn(){}function In(e){S(w=>{const m=new Set(w);return m.has(e)?m.delete(e):(m.add(e),W(C=>{const T=new Set(C);return T.add(e),T})),m})}async function Pn(e,w){if(!f.has(e)){g(m=>new Set(m).add(e));try{Z&&await Z(w)}catch(m){console.error("Failed to load more replies for chain:",m)}finally{g(m=>{const C=new Set(m);return C.delete(e),C})}}}const Fn=()=>{},Ln=o.useRef(null),Rn="904px",q="640px",[hn,On]=o.useState(0),[K,Tn]=o.useState(!0),[ln]=Vn(On,100),mn=1;o.useEffect(()=>{const e=l.current,w=document.getElementById("object-content"),m=()=>{if(K||!e||!w)return;const T=w.getBoundingClientRect(),H=e.getBoundingClientRect();if(T.height<=H.height){ln(100);return}const $=Math.max(0,H.top-T.top),y=w.offsetHeight-e.offsetHeight,I=Math.min(Math.max($/y*100,0),100),tn=Math.round(I/mn)*mn;ln(tn)};if(K)return;const C=new MutationObserver(m);return w&&C.observe(w,{childList:!0,subtree:!0,characterData:!0}),e?.addEventListener("scroll",m),m(),()=>{e?.removeEventListener("scroll",m),C.disconnect()}},[K,ln]);const[G,Mn]=o.useState([]),[An,$n]=o.useState(null),[nn,Dn]=o.useState(null),Bn=o.useCallback(e=>{Mn(e)},[]),qn=o.useCallback(e=>{Dn(e)},[]);o.useEffect(()=>{if(!nn?.contentDocument||!G.length)return;const w=setTimeout(()=>{const m=l.current;if(!m)return;const C=()=>{const T=nn.contentDocument;if(!T||!T.documentElement)return;const H=m.scrollTop,V=G.map(I=>T.getElementById(I.id)).filter(I=>I!==null).map(I=>({element:I,id:I.id,top:I.offsetTop}));if(!V.length)return;const $=100;let y=null;for(const I of V)if(I.top-$<=H)y=I;else break;$n(y?.id||null)};return m.addEventListener("scroll",C),C(),()=>{m.removeEventListener("scroll",C)}},100);return()=>clearTimeout(w)},[nn,G,An]);const en=En();return o.useEffect(()=>{const e=l.current;return()=>{e&&a&&Y.set(a,e.scrollTop)}},[a]),o.useEffect(()=>{if(!K&&!O&&a&&l.current){const e=Y.get(a);e!==void 0&&e>0&&setTimeout(()=>{l.current&&(l.current.scrollTop=e)},100)}},[K,O,a]),O?n.jsx("div",{className:`max-h-full overflow-auto rounded-md ${t==="DARK"&&"dark"} ${(t==="LIGHT"||t==="SEPIA")&&"light"} ${P[t].background}`,children:n.jsx("div",{className:"flex h-full flex-col",children:n.jsxs("div",{className:"relative flex-1",children:[n.jsx("div",{className:`sticky top-0 z-50 flex h-[102px] items-center justify-center rounded-t-md border-b max-md:h-[68px] ${P[t].background} ${P[t].border}`,children:n.jsxs("div",{className:"grid w-full px-8 max-lg:px-4",style:{gridTemplateColumns:`1fr minmax(0,${q}) 1fr`},children:[n.jsx("div",{className:"flex items-center",children:n.jsx(gn,{className:P[t].button,onClick:s})}),n.jsxs("div",{className:"col-[2/3] mx-auto flex w-full items-center gap-3 max-md:hidden",children:[n.jsx(E,{className:"size-10 rounded-full"}),n.jsxs("div",{className:"grow pt-1",children:[n.jsx(E,{className:"w-full"}),n.jsx(E,{className:"w-2/3"})]})]}),n.jsx("div",{className:"col-[3/4] flex items-center justify-end gap-2",children:n.jsx(wn,{backgroundColor:t,currentFontSizeIndex:p,fontStyle:c,onColorChange:i,onDecreaseFontSize:h,onFontStyleChange:u,onIncreaseFontSize:v,onOpenChange:_,onResetFontSize:r})})]})}),n.jsx("div",{className:"relative flex-1 max-lg:px-4",children:n.jsxs("div",{className:"mx-auto mt-11 w-full max-w-[640px]",children:[n.jsxs("div",{className:"mb-6 flex flex-col gap-2",children:[n.jsx(E,{className:"h-8"}),n.jsx(E,{className:"h-8 w-full max-w-md"})]}),n.jsx(E,{className:"mt-2 h-4",count:4,randomize:!0}),n.jsx(E,{className:"mt-8 h-[400px]"}),n.jsx(E,{className:"mt-2 h-4",containerClassName:"block mt-7 mb-4",count:8,randomize:!0})]})})]})})}):N?n.jsx("div",{ref:l,className:`max-h-full overflow-auto rounded-md ${t==="DARK"&&"dark"} ${(t==="LIGHT"||t==="SEPIA")&&"light"} ${P[t].background}`,"data-scrollable-container":!0,children:n.jsx(n.Fragment,{children:n.jsxs("div",{className:"flex h-full flex-col",children:[n.jsxs("div",{className:"relative flex-1",children:[n.jsx("div",{className:`sticky top-0 z-50 flex h-[102px] items-center justify-center rounded-t-md border-b max-md:h-[68px] ${P[t].background} ${P[t].border}`,children:n.jsxs("div",{className:"grid w-full px-8 max-lg:px-4",style:{gridTemplateColumns:`1fr minmax(0,${q}) 1fr`},children:[n.jsx("div",{className:"flex items-center",children:n.jsx(gn,{className:P[t].button,onClick:s})}),n.jsxs("div",{className:"col-[2/3] mx-auto flex w-full items-center justify-between gap-3 max-md:hidden",children:[n.jsx(Yn,{actor:B,isCurrentUser:x.authored,children:n.jsxs("div",{className:"flex cursor-pointer items-center gap-3",children:[n.jsx("div",{className:"relative z-10 pt-0.5",children:n.jsx(Qn,{author:B})}),n.jsxs("div",{className:"relative z-10 mt-0.5 flex min-w-0 cursor-pointer flex-col overflow-visible text-[1.5rem]",onClick:e=>Zn(B,en,e),children:[n.jsx("div",{className:"flex w-full",children:n.jsx("span",{className:"min-w-0 truncate whitespace-nowrap font-semibold text-black hover:underline dark:text-white",children:O?n.jsx(E,{className:"w-20"}):B.name})}),n.jsxs("div",{className:"flex w-full",children:[!O&&n.jsx("span",{className:'truncate text-gray-700 after:mx-1 after:font-normal after:text-gray-700 after:content-["·"]',children:fn(B)}),n.jsx("span",{className:"text-gray-700",children:O?n.jsx(E,{className:"w-[120px]"}):Jn(x,!x.authored)})]})]})]})}),!x.authored&&!O&&n.jsx(Xn,{following:B.followedByMe??!1,handle:fn(B)})]}),n.jsx("div",{className:"col-[3/4] flex items-center justify-end gap-2",children:n.jsx(wn,{backgroundColor:t,currentFontSizeIndex:p,fontStyle:c,onColorChange:i,onDecreaseFontSize:h,onFontStyleChange:u,onIncreaseFontSize:v,onOpenChange:_,onResetFontSize:r})})]})}),n.jsxs("div",{className:"relative flex-1",children:[n.jsx(we,{iframeElement:nn,modalRef:l,tocItems:G,onOpenChange:D}),!O&&n.jsx("div",{className:"grow overflow-y-auto",children:n.jsxs("div",{className:"mx-auto px-6 pb-10 pt-5",style:{maxWidth:Rn},children:[n.jsxs("div",{className:"flex flex-col items-center pb-8",id:"object-content",children:[n.jsx(ft,{authors:_n,backgroundColor:t,excerpt:x.summary??"",fontSize:k,fontStyle:c,heading:x.name,html:x.content??"",image:typeof x.image=="string"?x.image:x.image?.url,isPopoverOpen:d||F,postUrl:x?.url||"",onHeadingsExtracted:Bn,onIframeLoad:qn,onLoadingChange:Tn}),n.jsx("div",{className:"-ml-3 w-full",style:{maxWidth:q},children:n.jsx(Gn,{actor:B,commentCount:Nn,layout:"modal",likeCount:x.likeCount??0,object:x,repostCount:x.repostCount??0,onLikeClick:Fn})})]}),x.type==="Tombstone"&&n.jsx(fe,{last:!0}),n.jsxs("div",{className:"mx-auto w-full border-t border-black/[8%] dark:border-gray-950",style:{maxWidth:q},children:[n.jsx(be,{object:x}),n.jsx(jn,{})]}),O&&n.jsx(pn,{size:"lg"}),n.jsxs("div",{ref:Ln,className:"mx-auto w-full",style:{maxWidth:q},children:[Q.map((e,w)=>{const m=w===Q.length-1,C=e.mainReply.id,T=L.has(C),H=M.has(C),V=f.has(C),$=e.chain.length>0;return n.jsxs(rn.Fragment,{children:[n.jsx(an,{actor:e.mainReply.actor,allowDelete:e.mainReply.object.authored,commentCount:e.mainReply.object.replyCount??0,isChainParent:$,isPending:on(e.mainReply.id),last:!$,layout:"reply",likeCount:e.mainReply.object.likeCount??0,object:e.mainReply.object,parentId:x.id,repostCount:e.mainReply.object.repostCount??0,type:"Note",onClick:()=>{const y=l.current;y&&a&&Y.set(a,y.scrollTop),en(`/notes/${encodeURIComponent(e.mainReply.id)}`)},onDelete:sn}),$&&e.chain[0]&&n.jsx(an,{actor:e.chain[0].actor,allowDelete:e.chain[0].object.authored,commentCount:e.chain[0].object.replyCount??0,isChainContinuation:!0,isPending:on(e.chain[0].id),last:e.chain.length===1,layout:"reply",likeCount:e.chain[0].object.likeCount??0,object:e.chain[0].object,parentId:x.id,repostCount:e.chain[0].object.repostCount??0,type:"Note",onClick:()=>{const y=l.current;y&&a&&Y.set(a,y.scrollTop),en(`/notes/${encodeURIComponent(e.chain[0].id)}`)},onDelete:sn},e.chain[0].id),$&&T&&e.chain.slice(1).map((y,I)=>{const tn=I===e.chain.slice(1).length-1,Hn=X&&X(w),Un=tn&&Hn;return n.jsx(an,{actor:y.actor,allowDelete:y.object.authored,commentCount:y.object.replyCount??0,isChainContinuation:!0,isPending:on(y.id),last:tn&&!Un,layout:"reply",likeCount:y.object.likeCount??0,object:y.object,parentId:x.id,repostCount:y.object.repostCount??0,type:"Note",onClick:()=>{const kn=l.current;kn&&a&&Y.set(a,kn.scrollTop),en(`/notes/${encodeURIComponent(y.id)}`)},onDelete:sn},y.id)}),$&&e.chain.length>1&&!T&&n.jsx(xn,{variant:"expand",onClick:()=>In(C)}),$&&T&&H&&X&&X(w)&&n.jsx(xn,{loading:V,variant:"loadMore",onClick:()=>Pn(C,w)}),!m&&n.jsx(jn,{})]},e.mainReply.id)}),R&&n.jsx("div",{className:"flex flex-col items-center justify-center text-center",children:n.jsx(pn,{size:"md"})})]}),J&&n.jsx("div",{ref:b,className:"h-1"})]})})]})]}),!O&&n.jsxs("div",{className:"pointer-events-none !visible sticky bottom-0 hidden items-end justify-between px-10 pb-[42px] lg:!flex",children:[n.jsx("div",{className:"pointer-events-auto text-gray-600",children:ne(x.content??"")}),n.jsxs("div",{className:"pointer-events-auto min-w-10 text-right text-gray-600 transition-all duration-200 ease-out",children:[hn,"%"]},hn)]})]})})}):n.jsx("div",{className:`max-h-full overflow-auto rounded-md ${t==="DARK"&&"dark"} ${(t==="LIGHT"||t==="SEPIA")&&"light"} ${P[t].background}`,children:n.jsx("div",{className:"flex h-full flex-col",children:n.jsx("div",{className:"relative flex-1",children:n.jsx("div",{className:`sticky top-0 z-50 flex h-[102px] items-center justify-center rounded-t-md border-b max-md:h-[68px] ${P[t].background} ${P[t].border}`,children:n.jsxs("div",{className:"grid w-full px-8 max-lg:px-4",style:{gridTemplateColumns:`1fr minmax(0,${q}) 1fr`},children:[n.jsx("div",{className:"flex items-center",children:n.jsx(gn,{className:P[t].button,onClick:s})}),n.jsx("div",{className:"col-[2/3] mx-auto flex w-full items-center gap-3 max-md:hidden",children:n.jsx("div",{className:"grow text-center",children:n.jsx("span",{children:"Error loading article."})})})]})})})})})},xt=({isLoading:a,activities:s,currentTopic:t,fetchNextPage:p,hasNextPage:c,isFetchingNextPage:k,onTopicChange:i})=>{const u=En(),{canGoBack:v,goBack:h}=te(),[r,l]=o.useState(!1),d=ae(),{topicsQuery:_}=oe(),{data:F}=_,D=F&&F.topics.length>0;o.useEffect(()=>{l(!!d.postId)},[d.postId]);const L=o.useRef(null),S=o.useRef(null),M=o.useRef(null);o.useEffect(()=>(L.current&&L.current.disconnect(),L.current=new IntersectionObserver(f=>{f[0].isIntersecting&&c&&!k&&p()}),S.current&&L.current.observe(S.current),M.current&&L.current.observe(M.current),()=>{L.current&&L.current.disconnect()}),[c,k,p]);const W=Math.max(0,Math.floor(s.length*.75)-1);return n.jsxs(re,{children:[D&&n.jsx(xe,{currentTopic:t,excludeTopics:["top"],onTopicChange:i}),n.jsx("div",{className:"flex w-full flex-col",children:n.jsx("div",{className:"w-full",children:s.length>0?n.jsx("div",{className:"my-4",children:n.jsx("div",{className:"mx-auto flex min-h-[calc(100dvh_-_117px)] items-start gap-11",children:n.jsx("div",{className:"flex w-full min-w-0 flex-col items-center",children:n.jsxs("div",{className:"flex w-full min-w-0 flex-col items-start",children:[n.jsxs("ul",{className:"mx-auto flex w-full flex-col","data-testid":"inbox-list",children:[s.map((f,g)=>n.jsxs("li",{"data-testid":"inbox-item","data-test-view-article":!0,children:[n.jsx(an,{actor:f.actor,allowDelete:f.object.authored,commentCount:f.object.replyCount??0,isLoading:a,isPending:on(f.id),layout:"inbox",likeCount:f.object.likeCount??0,object:f.object,repostCount:f.object.repostCount??0,type:f.type,onClick:()=>{u(`/reader/${encodeURIComponent(f.id)}`)}}),g<s.length-1&&n.jsx(ie,{}),g===W&&n.jsx("div",{ref:S,className:"h-1"})]},`${f.id}-${f.type}-${g}`)),k&&n.jsx("li",{className:"flex flex-col items-center justify-center space-y-4 text-center",children:n.jsx(pn,{size:"md"})})]}),n.jsx("div",{ref:M,className:"h-1"})]})})})}):t!=="following"?n.jsx("div",{className:"mt-[24vh]",children:n.jsx(vn,{description:"Explore other topics for more content.",title:"Nothing here yet",children:n.jsx(yn,{})})}):n.jsx("div",{className:"mt-[24vh]",children:n.jsx(vn,{actions:D?n.jsx(A,{onClick:()=>u("/explore"),children:"Find accounts to follow →"}):n.jsx(A,{asChild:!0,children:n.jsx("a",{href:"https://explore.ghost.org/social-web",rel:"noopener noreferrer",target:"_blank",children:"Find accounts to follow →"})}),description:"Start following publishers to see their long-form posts here.",title:"Your Reader is empty",children:n.jsx(yn,{})})})})}),n.jsx(de,{open:r,onOpenChange:f=>{f||(v?h():u("/reader")),l(f)},children:n.jsxs(ce,{className:"inset-y-3 h-[calc(100vh-24px)] w-screen max-w-[calc(100vw-24px)] !animate-none p-0 focus:outline-none dark:bg-gray-950",children:[n.jsxs(se,{className:"hidden",children:[n.jsx(le,{children:"Reader"}),n.jsx(ge,{children:"Ghost reader for long form articles"})]}),d.postId&&n.jsx(bt,{postId:d.postId,onClose:()=>{v?h():u("/reader")}})]})})]})},Et=()=>{const[a,s]=o.useState("following"),{inboxQuery:t}=pe({enabled:a==="following"}),{discoveryFeedQuery:p}=ue({enabled:a!=="following",topic:a}),c=a==="following"?t:p,{data:k,error:i,fetchNextPage:u,hasNextPage:v,isFetchingNextPage:h,isLoading:r}=c,l=i&&bn(i)&&i.statusCode===404&&a!=="following";if(i&&bn(i)&&!l)return n.jsx(he,{errorCode:i.code,statusCode:i.statusCode});const d=l?[]:k?.pages.flatMap(_=>_.posts)??Array.from({length:5},(_,F)=>({id:`placeholder-${F}`,object:{}}));return n.jsx(xt,{activities:d,currentTopic:a,fetchNextPage:u,hasNextPage:v,isFetchingNextPage:h,isLoading:r,onTopicChange:s})};export{Et as default};
