import { w as I, R as b, C as _e, P as _t, x as fe, y as De, j as u, n as St, z as xe, A as Nt, e as Y, f as Se, B as ot, v as Tt, u as $t, s as Et } from "./index-DP6CzQAF.mjs";
import { p as Ct, f as zt, S as Le, a as Re, b as Ie, c as Ve, d as Be, e as Me, g as We } from "./source-icon-UFyXVics.mjs";
import { B as Fe, H as Dt } from "./heading-CN611yBx.mjs";
import { l as Lt, m as Rt, C as st, a as It, b as Vt, j as Bt, c as lt, k as Mt, T as Wt } from "./post-analytics-header-DpQulaIB.mjs";
import { m as Ft, n as S, G as ct, o as pe, p as Kt, q as L, r as Gt, s as me, t as C, u as Ke, L as B, v as Ht, w as Yt, x as Ne, y as Te, z as Xt, A as qt, B as Ut, C as Ge, E as ut, F as he, H as ie, I as ye, J as Jt, K, N as He, O as Qt, P as Ye, Q as Zt, R as er, V as tr, W as Xe, X as qe, Y as rr, Z as ir, _ as nr, $ as ar, a0 as or, a1 as sr, a2 as lr, a3 as cr, a4 as ur, D as fr, h as hr, i as Ue, a as dr, b as vr, c as pr, d as mr, e as yr, f as br, g as gr, a5 as xr, a6 as wr, a7 as Je, a8 as ne, a9 as Or } from "./tabs-CdduOWr1.mjs";
import { b as jr } from "./skeleton-COjEE1lX.mjs";
import { S as Pr, u as kr } from "./post-analytics-context-DJd7gfVm.mjs";
import { b as Ar, d as _r, e as Sr, f as Qe } from "./dropdown-menu-C1s2rpqw.mjs";
function ft(e, t, i) {
  if (t < 1)
    return [];
  if (t === 1 && i === void 0)
...
var V = /* @__PURE__ */ function(e) {
  ...
  return mi(t, e), hi(t, [{
    ...
    value: function(r, n) {
      ...
      return s && o && o.length && (!c && d > 0 || !Ye(c, o) || !Ye(h, l)) ? this.renderAreaWithAnimation(r, n) : this.renderAreaStatically(o, l, r, n);
    }
  }, {
    key: "render",
    value: function() {
      ...
      if (a || !l || !l.length)
        return null;
      var j = this.state.isAnimationFinished, w = l.length === 1, g = I("recharts-area", s), x = h && h.allowDataOverflow, O = d && d.allowDataOverflow, P = x || O, k = He(m) ? this.id : m, _ = (r = C(o, !1)) !== null && r !== void 0 ? r : {
        r: 3,
        strokeWidth: 2
...
D(V, "getComposedData", function(e) {
  var t = e.props, i = e.item, r = e.xAxis, n = e.yAxis, a = e.xAxisTicks, o = e.yAxisTicks, l = e.bandSize, s = e.dataKey, f = e.stackedData, c = e.dataStartIndex, h = e.displayedData, d = e.offset, v = t.layout, p = f && f.length, y = mt.getBaseValue(t, i, r, n), m = v === "horizontal", j = !1, w = h.map(function(x, O) {
    var P;
    p ? P = f[c + O] : (P = Xe(x, s), Array.isArray(P) ? j = !0 : P = [y, P]);
    var k = P[1] == null || p && Xe(x, s) == null;
    return m ? {
      x: qe({
        axis: r,
        ticks: a,
      ...
      j && /* @__PURE__ */ u.jsx("div", { className: "mt-4", children: /* @__PURE__ */ u.jsxs(Le, { children: [
        ...
        /* @__PURE__ */ u.jsxs(Ie, { className: "overflow-y-auto pt-0 sm:max-w-[600px]", children: [
          /* @__PURE__ */ u.jsxs(Ve, { className: "sticky top-0 z-40 -mx-6 bg-background/60 p-6 backdrop-blur", children: [
            /* @__PURE__ */ u.jsx(Be, { children: v }),
            /* @__PURE__ */ u.jsx(Me, { children: p })
          ] }),
...
//# sourceMappingURL=kpis-RaLrDy9e.mjs.map
