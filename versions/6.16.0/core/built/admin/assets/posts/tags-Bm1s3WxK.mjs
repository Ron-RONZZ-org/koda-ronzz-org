import { o as h, j as e, R as g, D as Y, n as w, Q as J, N as K, X as S, p as W, e as Z, Y as ee } from "./index-DP6CzQAF.mjs";
import { u as G, P as T, c as se, B as b } from "./heading-CN611yBx.mjs";
import { a as ae, d as $, I as te, u as re, R as le } from "./skeleton-COjEE1lX.mjs";
import { H as m, u as oe } from "./use-infinite-virtual-scroll-CfZ2ymj-.mjs";
import { M as ne } from "./main-layout-DYKI4Skg.mjs";
import { T as ie, a as ce, b as P, c as j, d as de, e as f } from "./table-afZFO3VM.mjs";
import { P as ue, T as ge } from "./tags-lXnaYznd.mjs";
import { E as pe } from "./empty-indicator-Cyc-Fljl.mjs";
import { L as xe } from "./loading-indicator-Cn2-CAmI.mjs";
import { d as me } from "./hooks-DCiJHQ9c.mjs";
...
C.displayName = A;
var M = C, x = "ToggleGroup", [V] = se(x, [
  $
]), L = $(), I = g.forwardRef((s, t) => {
  const { type: r, ...a } = s;
  if (r === "single") {
    const l = a;
...
const U = J({
  size: "default",
  variant: "default"
}), X = h(({ className: s, variant: t, size: r, children: a, ...l }, o) => /* @__PURE__ */ e.jsx(
  O,
  {
    ref: o,
...
const Ne = ({ children: s, className: t, ...r }) => /* @__PURE__ */ e.jsx("section", { className: w("flex gap-6 flex-col p-4 lg:p-8 size-full grow", t), ...r, children: s }), we = ({ currentTab: s }) => /* @__PURE__ */ e.jsxs(m, { variant: "inline-nav", children: [
  ...
  /* @__PURE__ */ e.jsxs(m.Actions, { children: [
    /* @__PURE__ */ e.jsx(m.ActionGroup, { children: /* @__PURE__ */ e.jsxs(X, { "data-testid": "tags-header-tabs", size: "button", type: "single", value: s, children: [
...
function ye({
  ...
  const o = W(null), { visibleItems: n, spaceBefore: i, spaceAfter: d } = oe({
    items: s,
    totalItems: t,
    hasNextPage: r,
    isFetchingNextPage: a,
            ...
            return u.index > s.length - 1 ? /* @__PURE__ */ e.jsx(Pe, { ...v }, p) : /* @__PURE__ */ e.jsxs(
              P,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ e.jsx(f, { className: "col-start-1 col-end-1 row-start-3 row-end-3 flex p-0 md:col-start-2 md:col-end-2 md:row-start-1 md:row-end-3 lg:table-cell lg:p-4", children: (_ = c.count) != null && _.posts ? /* @__PURE__ */ e.jsx(
                    "a",
                    {
...
//# sourceMappingURL=tags-Bm1s3WxK.mjs.map
