import { ad as q, c as C, ax as E, e as Q, ay as T, aj as K, az as tt, ai as et, aA as it, aB as st, aC as X } from "./index-BP8K8A9r.mjs";
...
class H extends mt {
  ...
  set data(t) {
    ...
    if (this.created) {
      const l = this._data;
      this._data = t, this.computedTrend = typeof this.trend == "function" ? this.trend(l.value, o) : this.trend, this.computedAnimated = z && this._animated && (!this.respectMotionPreference || !(p != null && p.matches)) && // https://github.com/barvian/number-flow/issues/9
      ...
      if (typeof CSSStyleSheet < "u" && this.shadowRoot.adoptedStyleSheets)
        S || (S = new CSSStyleSheet(), S.replaceSync(B)), this.shadowRoot.adoptedStyleSheets = [S];
      else {
        const l = document.createElement("style");
        l.textContent = B, this.shadowRoot.appendChild(l);
      }
...
const bt = () => X(() => () => {
}, () => z, () => !1), St = () => X((n) => (p == null || p.addEventListener("change", n), () => p == null ? void 0 : p.removeEventListener("change", n)), () => p.matches, () => !1);
...
//# sourceMappingURL=index-TUVI_t4A.mjs.map
