import { ad as _, j as t, ae as mA, a6 as G3, ai as N2, aj as V3, b as eA, ag as e4, bj as b6, e as P, an as m2, c as G, a_ as Z6, af as I2, bk as j6, bl as y6, bm as O6, bn as S6, bo as D6, bp as T6, bq as L6, br as G6, bs as V6, bt as z6, bu as U1, bv as P6, bw as X6, bx as W6, W as lA, by as k6, ak as J6, am as R1, ax as q6, a$ as Y6, bz as _6, b0 as $6, s as b1, al as A7, R as fA, b1 as r7, bA as e7, bB as $2, I as z3, bC as t7, B as P3, k as n7, A as s7, S as A3, Y as C7, O as d4, Q as o7, av as a7, aw as l7, L as i7 } from "./index-BP8K8A9r.mjs";
import { c as X3, I as c7, u as B7, R as u7 } from "./index-CZBIQsb2.mjs";
import { C as W3 } from "./copy-Bl-JESm3.mjs";
import { a as f7 } from "./settings-YLRHPKQk.mjs";
var d7 = Object.freeze({
...
function FA(A, r, { checkForDefaultPrevented: e = !0 } = {}) {
  return function(s) {
    if (A == null || A(s), e === !1 || !s.defaultPrevented)
      return r == null ? void 0 : r(s);
  };
}
var E7 = "DismissableLayer", n2 = "dismissableLayer.update", F7 = "dismissableLayer.pointerDownOutside", x7 = "dismissableLayer.focusOutside", r3, J3 = V3({
  ...
  (A, r) => {
    const {
      ...
      onDismiss: a,
      ...i
    } = A, l = N2(J3), [c, B] = eA(null), u = (c == null ? void 0 : c.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, h] = eA({}), U = e4(r, (x) => B(x)), w = Array.from(l.layers), [p] = [...l.layersWithOutsidePointerEventsDisabled].slice(-1), Q = w.indexOf(p), v = c ? w.indexOf(c) : -1, I = l.layersWithOutsidePointerEventsDisabled.size > 0, M = v >= Q, Z = M7((x) => {
      const K = x.target, H = [...l.branches].some((j) => j.contains(K));
      !M || H || (s == null || s(x), o == null || o(x), x.defaultPrevented || a == null || a());
    }, u), N = N7((x) => {
      const K = x.target;
      [...l.branches].some((j) => j.contains(K)) || (C == null || C(x), o == null || o(x), x.defaultPrevented || a == null || a());
    }, u);
    return b6((x) => {
      v === l.layers.size - 1 && (n == null || n(x), !x.defaultPrevented && a && (x.preventDefault(), a()));
    }, u), P(() => {
      if (c)
        return e && (l.layersWithOutsidePointerEventsDisabled.size === 0 && (r3 = u.body.style.pointerEvents, u.body.style.pointerEvents = "none"), l.layersWithOutsidePointerEventsDisabled.add(c)), l.layers.add(c), e3(), () => {
          e && l.layersWithOutsidePointerEventsDisabled.size === 1 && (u.body.style.pointerEvents = r3);
        };
    }, [c, u, e, l]), P(() => () => {
      c && (l.layers.delete(c), l.layersWithOutsidePointerEventsDisabled.delete(c), e3());
    }, [c, l]), P(() => {
      const x = () => h({});
      return document.addEventListener(n2, x), () => document.removeEventListener(n2, x);
    }, []), /* @__PURE__ */ t.jsx(
      mA.div,
      {
        ...i,
        ...
        onFocusCapture: FA(A.onFocusCapture, N.onFocusCapture),
        onBlurCapture: FA(A.onBlurCapture, N.onBlurCapture),
...
q3.displayName = E7;
var H7 = "DismissableLayerBranch", v7 = _((A, r) => {
  const e = N2(J3), n = G(null), s = e4(r, n);
  return P(() => {
    const C = n.current;
    if (C)
  ...
  }, [e.branches]), /* @__PURE__ */ t.jsx(mA.div, { ...A, ref: s });
});
v7.displayName = H7;
function M7(A, r = globalThis == null ? void 0 : globalThis.document) {
  const e = m2(A), n = G(!1), s = G(() => {
  });
  return P(() => {
    const C = (a) => {
      if (a.target && !n.current) {
        ...
        a.pointerType === "touch" ? (r.removeEventListener("click", s.current), s.current = i, r.addEventListener("click", s.current, { once: !0 })) : i();
      } else
    ...
    return () => {
      window.clearTimeout(o), r.removeEventListener("pointerdown", C), r.removeEventListener("click", s.current);
    };
  }, [r, e]), {
...
function N7(A, r = globalThis == null ? void 0 : globalThis.document) {
  const e = m2(A), n = G(!1);
  return P(() => {
    const s = (C) => {
      C.target && !n.current && Y3(x7, e, { originalEvent: C }, {
        discrete: !1
      });
    };
...
function e3() {
  const A = new CustomEvent(n2);
  document.dispatchEvent(A);
}
function Y3(A, r, e, { discrete: n }) {
  const s = e.originalEvent.target, C = new CustomEvent(A, { bubbles: !1, cancelable: !0, detail: e });
  r && s.addEventListener(A, r, { once: !0 }), n ? Z6(s, C) : s.dispatchEvent(C);
}
var K2 = "Popper", [_3, $3] = I2(K2), [m7, A5] = _3(K2), r5 = (A) => {
  const { __scopePopper: r, children: e } = A, [n, s] = eA(null);
  return /* @__PURE__ */ t.jsx(m7, { scope: r, anchor: n, onAnchorChange: s, children: e });
};
r5.displayName = K2;
var e5 = "PopperAnchor", t5 = _(
  (A, r) => {
    const { __scopePopper: e, virtualRef: n, ...s } = A, C = A5(e5, e), o = G(null), a = e4(r, o), i = G(null);
    return P(() => {
      const l = i.current;
      i.current = (n == null ? void 0 : n.current) || o.current, l !== i.current && C.onAnchorChange(i.current);
    }), n ? null : /* @__PURE__ */ t.jsx(mA.div, { ...s, ref: a });
  }
);
t5.displayName = e5;
var R2 = "PopperContent", [I7, K7] = _3(R2), n5 = _(
  (A, r) => {
    var X2, W2, k2, J2, q2, Y2;
    const {
      __scopePopper: e,
      side: n = "bottom",
      sideOffset: s = 0,
      ...
      onPlaced: U,
      ...w
    } = A, p = A5(R2, e), [Q, v] = eA(null), I = e4(r, (H4) => v(H4)), [M, Z] = eA(null), N = j6(M), x = (N == null ? void 0 : N.width) ?? 0, K = (N == null ? void 0 : N.height) ?? 0, H = n + (C !== "center" ? "-" + C : ""), j = typeof c == "number" ? c : { top: 0, right: 0, bottom: 0, left: 0, ...c }, m = Array.isArray(l) ? l : [l], y = m.length > 0, b = {
      padding: j,
      boundary: m.filter(b7),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: y
    }, { refs: gA, floatingStyles: q, placement: $, isPositioned: KA, middlewareData: nA } = y6({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: H,
      whileElementsMounted: (...H4) => z6(...H4, {
      ...
      middleware: [
        O6({ mainAxis: s + K, alignmentAxis: o }),
        i && S6({
          mainAxis: !0,
          crossAxis: !1,
          limiter: B === "partial" ? V6() : void 0,
          ...b
        }),
        i && D6({ ...b }),
        T6({
          ...b,
          apply: ({ elements: H4, rects: _2, availableWidth: m6, availableHeight: I6 }) => {
            const { width: K6, height: R6 } = _2.reference, _4 = H4.floating.style;
            _4.setProperty("--radix-popper-available-width", `${m6}px`), _4.setProperty("--radix-popper-available-height", `${I6}px`), _4.setProperty("--radix-popper-anchor-width", `${K6}px`), _4.setProperty("--radix-popper-anchor-height", `${R6}px`);
          }
        }),
        M && L6({ element: M, padding: a }),
        Z7({ arrowWidth: x, arrowHeight: K }),
        u && G6({ strategy: "referenceHidden", ...b })
      ]
    }), [t4, E4] = o5($), RA = m2(U);
    U1(() => {
      KA && (RA == null || RA());
    }, [KA, RA]);
    const WA = (X2 = nA.arrow) == null ? void 0 : X2.x, F4 = (W2 = nA.arrow) == null ? void 0 : W2.y, x4 = ((k2 = nA.arrow) == null ? void 0 : k2.centerOffset) !== 0, [bA, kA] = eA();
    return U1(() => {
      Q && kA(window.getComputedStyle(Q).zIndex);
    }, [Q]), /* @__PURE__ */ t.jsx(
      "div",
      {
        ref: gA.setFloating,
        ...
        style: {
          ...q,
          transform: KA ? q.transform : "translate(0, -200%)",
          // keep off the page when measuring
          minWidth: "max-content",
          zIndex: bA,
          "--radix-popper-transform-origin": [
            (J2 = nA.transformOrigin) == null ? void 0 : J2.x,
            (q2 = nA.transformOrigin) == null ? void 0 : q2.y
          ].join(" "),
          // hide the content if using the hide middleware and should be hidden
          // set visibility to hidden and disable pointer events so the UI behaves
          // as if the PopperContent isn't there at all
          ...((Y2 = nA.hide) == null ? void 0 : Y2.referenceHidden) && {
            visibility: "hidden",
            pointerEvents: "none"
          }
        },
...
n5.displayName = R2;
var s5 = "PopperArrow", R7 = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, C5 = _(function(r, e) {
  const { __scopePopper: n, ...s } = r, C = K7(s5, n), o = R7[C.placedSide];
  return (
...
var Z7 = (A) => ({
  ...
  fn(r) {
    var p, Q, v;
    const { placement: e, rects: n, middlewareData: s } = r, o = ((p = s.arrow) == null ? void 0 : p.centerOffset) !== 0, a = o ? 0 : A.arrowWidth, i = o ? 0 : A.arrowHeight, [l, c] = o5(e), B = { start: "0%", center: "50%", end: "100%" }[c], u = (((Q = s.arrow) == null ? void 0 : Q.x) ?? 0) + a / 2, h = (((v = s.arrow) == null ? void 0 : v.y) ?? 0) + i / 2;
    let U = "", w = "";
    return l === "bottom" ? (U = o ? B : `${u}px`, w = `${-i}px`) : l === "top" ? (U = o ? B : `${u}px`, w = `${n.floating.height + i}px`) : l === "right" ? (U = `${-i}px`, w = o ? B : `${h}px`) : l === "left" && (U = `${n.floating.width + i}px`, w = o ? B : `${h}px`), { data: { x: U, y: w } };
  }
});
function o5(A) {
  const [r, e = "center"] = A.split("-");
  return [r, e];
}
var j7 = r5, y7 = t5, O7 = n5, S7 = C5;
function D7(A, r) {
  return k6((e, n) => r[e][n] ?? e, A);
}
var b2 = (A) => {
  const { present: r, children: e } = A, n = T7(r), s = typeof e == "function" ? e({ present: n.isPresent }) : X6.only(e), C = e4(n.ref, L7(s));
  return typeof e == "function" || n.isPresent ? W6(s, { ref: C }) : null;
};
b2.displayName = "Presence";
function T7(A) {
  const [r, e] = eA(), n = G(null), s = G(A), C = G("none"), o = A ? "mounted" : "unmounted", [a, i] = D7(o, {
    mounted: {
      UNMOUNT: "unmounted",
  ...
  return P(() => {
    ...
    if (c !== A) {
      const u = C.current, h = $4(l);
      A ? i("MOUNT") : h === "none" || (l == null ? void 0 : l.display) === "none" ? i("UNMOUNT") : i(c && u !== h ? "ANIMATION_OUT" : "UNMOUNT"), s.current = A;
    }
  }, [A, i]), U1(() => {
    if (r) {
      let l;
      const c = r.ownerDocument.defaultView ?? window, B = (h) => {
        const w = $4(n.current).includes(CSS.escape(h.animationName));
        if (h.target === r && w && (i("ANIMATION_END"), !s.current)) {
          const p = r.style.animationFillMode;
          r.style.animationFillMode = "forwards", l = c.setTimeout(() => {
            r.style.animationFillMode === "forwards" && (r.style.animationFillMode = p);
          });
        }
      }, u = (h) => {
        h.target === r && (C.current = $4(n.current));
      };
      return r.addEventListener("animationstart", u), r.addEventListener("animationcancel", B), r.addEventListener("animationend", B), () => {
        c.clearTimeout(l), r.removeEventListener("animationstart", u), r.removeEventListener("animationcancel", B), r.removeEventListener("animationend", B);
      };
    } else
      i("ANIMATION_END");
  }, [r, i]), {
    ...
    ref: lA((l) => {
      n.current = l ? getComputedStyle(l) : null, e(l);
    }, [])
  };
}
function $4(A) {
...
function L7(A) {
  var n, s;
  let r = (n = Object.getOwnPropertyDescriptor(A.props, "ref")) == null ? void 0 : n.get, e = r && "isReactWarning" in r && r.isReactWarning;
  return e ? A.ref : (r = (s = Object.getOwnPropertyDescriptor(A, "ref")) == null ? void 0 : s.get, e = r && "isReactWarning" in r && r.isReactWarning, e ? A.props.ref : A.props.ref || A.ref);
}
var [Z1] = I2("Tooltip", [
  $3
]), j1 = $3(), a5 = "TooltipProvider", G7 = 700, s2 = "tooltip.open", [V7, Z2] = Z1(a5), l5 = (A) => {
  const {
    __scopeTooltip: r,
    delayDuration: e = G7,
  ...
  return P(() => {
    ...
    V7,
    {
      ...
      delayDuration: e,
      onOpen: lA(() => {
        window.clearTimeout(i.current), o.current = !1;
      }, []),
      onClose: lA(() => {
...
l5.displayName = a5;
var P4 = "Tooltip", [z7, q4] = Z1(P4), i5 = (A) => {
  const {
    __scopeTooltip: r,
    children: e,
    open: n,
    ...
    delayDuration: a
  } = A, i = Z2(P4, A.__scopeTooltip), l = j1(r), [c, B] = eA(null), u = J6(), h = G(0), U = o ?? i.disableHoverableContent, w = a ?? i.delayDuration, p = G(!1), [Q, v] = R1({
    prop: n,
    defaultProp: s ?? !1,
    onChange: (x) => {
      x ? (i.onOpen(), document.dispatchEvent(new CustomEvent(s2))) : i.onClose(), C == null || C(x);
    },
    caller: P4
  }), I = q6(() => Q ? p.current ? "delayed-open" : "instant-open" : "closed", [Q]), M = lA(() => {
    window.clearTimeout(h.current), h.current = 0, p.current = !1, v(!0);
  }, [v]), Z = lA(() => {
    window.clearTimeout(h.current), h.current = 0, v(!1);
  }, [v]), N = lA(() => {
    window.clearTimeout(h.current), h.current = window.setTimeout(() => {
      p.current = !0, v(!0), h.current = 0;
    }, w);
  }, [w, v]);
  return P(() => () => {
    h.current && (window.clearTimeout(h.current), h.current = 0);
  }, []), /* @__PURE__ */ t.jsx(j7, { ...l, children: /* @__PURE__ */ t.jsx(
    z7,
    {
      scope: r,
      contentId: u,
      ...
      onTriggerChange: B,
      onTriggerEnter: lA(() => {
        i.isOpenDelayedRef.current ? N() : M();
      }, [i.isOpenDelayedRef, N, M]),
      onTriggerLeave: lA(() => {
...
i5.displayName = P4;
var C2 = "TooltipTrigger", c5 = _(
  (A, r) => {
    const { __scopeTooltip: e, ...n } = A, s = q4(C2, e), C = Z2(C2, e), o = j1(e), a = G(null), i = e4(r, a, s.onTriggerChange), l = G(!1), c = G(!1), B = lA(() => l.current = !1, []);
    return P(() => () => document.removeEventListener("pointerup", B), [B]), /* @__PURE__ */ t.jsx(y7, { asChild: !0, ...o, children: /* @__PURE__ */ t.jsx(
      mA.button,
      {
        ...
        ...n,
        ref: i,
        onPointerMove: FA(A.onPointerMove, (u) => {
          u.pointerType !== "touch" && !c.current && !C.isPointerInTransitRef.current && (s.onTriggerEnter(), c.current = !0);
        }),
        onPointerLeave: FA(A.onPointerLeave, () => {
          s.onTriggerLeave(), c.current = !1;
        }),
        onPointerDown: FA(A.onPointerDown, () => {
          s.open && s.onClose(), l.current = !0, document.addEventListener("pointerup", B, { once: !0 });
        }),
        onFocus: FA(A.onFocus, () => {
          l.current || s.onOpen();
        }),
        onBlur: FA(A.onBlur, s.onClose),
        onClick: FA(A.onClick, s.onClose)
      }
    ) });
  }
);
c5.displayName = C2;
var j2 = "TooltipPortal", [P7, X7] = Z1(j2, {
  forceMount: void 0
}), B5 = (A) => {
  const { __scopeTooltip: r, forceMount: e, children: n, container: s } = A, C = q4(j2, r);
  return /* @__PURE__ */ t.jsx(P7, { scope: r, forceMount: e, children: /* @__PURE__ */ t.jsx(b2, { present: e || C.open, children: /* @__PURE__ */ t.jsx(Y6, { asChild: !0, container: s, children: n }) }) });
};
B5.displayName = j2;
var p4 = "TooltipContent", u5 = _(
  (A, r) => {
    const e = X7(p4, A.__scopeTooltip), { forceMount: n = e.forceMount, side: s = "top", ...C } = A, o = q4(p4, A.__scopeTooltip);
    return /* @__PURE__ */ t.jsx(b2, { present: n || o.open, children: o.disableHoverableContent ? /* @__PURE__ */ t.jsx(f5, { side: s, ...C, ref: r }) : /* @__PURE__ */ t.jsx(W7, { side: s, ...C, ref: r }) });
  }
), W7 = _((A, r) => {
  const e = q4(p4, A.__scopeTooltip), n = Z2(p4, A.__scopeTooltip), s = G(null), C = e4(r, s), [o, a] = eA(null), { trigger: i, onClose: l } = e, c = s.current, { onPointerInTransitChange: B } = n, u = lA(() => {
    a(null), B(!1);
  }, [B]), h = lA(
    (U, w) => {
      const p = U.currentTarget, Q = { x: U.clientX, y: U.clientY }, v = _7(Q, p.getBoundingClientRect()), I = $7(Q, v), M = A8(w.getBoundingClientRect()), Z = e8([...I, ...M]);
      a(Z), B(!0);
    },
    [B]
  );
  return P(() => () => u(), [u]), P(() => {
    if (i && c) {
      const U = (p) => h(p, c), w = (p) => h(p, i);
      return i.addEventListener("pointerleave", U), c.addEventListener("pointerleave", w), () => {
        i.removeEventListener("pointerleave", U), c.removeEventListener("pointerleave", w);
      };
    }
  }, [i, c, h, u]), P(() => {
    if (o) {
      const U = (w) => {
        const p = w.target, Q = { x: w.clientX, y: w.clientY }, v = (i == null ? void 0 : i.contains(p)) || (c == null ? void 0 : c.contains(p)), I = !r8(Q, o);
        v ? u() : I && (u(), l());
      };
      return document.addEventListener("pointermove", U), () => document.removeEventListener("pointermove", U);
    }
  }, [i, c, o, l, u]), /* @__PURE__ */ t.jsx(f5, { ...A, ref: C });
}), [k7, J7] = Z1(P4, { isInside: !1 }), q7 = _6("TooltipContent"), f5 = _(
  (A, r) => {
    const {
      __scopeTooltip: e,
      children: n,
      ...
      ...a
    } = A, i = q4(p4, e), l = j1(e), { onClose: c } = i;
    return P(() => (document.addEventListener(s2, c), () => document.removeEventListener(s2, c)), [c]), P(() => {
      if (i.trigger) {
        const B = (u) => {
          const h = u.target;
          h != null && h.contains(i.trigger) && c();
        };
        return window.addEventListener("scroll", B, { capture: !0 }), () => window.removeEventListener("scroll", B, { capture: !0 });
      }
    }, [i.trigger, c]), /* @__PURE__ */ t.jsx(
      q3,
      {
        asChild: !0,
        ...
        children: /* @__PURE__ */ t.jsxs(
          O7,
          {
            ...
            children: [
              /* @__PURE__ */ t.jsx(q7, { children: n }),
              /* @__PURE__ */ t.jsx(k7, { scope: e, isInside: !0, children: /* @__PURE__ */ t.jsx(Q7, { id: i.contentId, role: "tooltip", children: s || n }) })
            ]
          }
        )
      }
...
u5.displayName = p4;
var d5 = "TooltipArrow", Y7 = _(
  (A, r) => {
    const { __scopeTooltip: e, ...n } = A, s = j1(e);
    return J7(
      d5,
      e
    ).isInside ? null : /* @__PURE__ */ t.jsx(S7, { ...s, ...n, ref: r });
  }
);
Y7.displayName = d5;
function _7(A, r) {
  const e = Math.abs(r.top - A.y), n = Math.abs(r.bottom - A.y), s = Math.abs(r.right - A.x), C = Math.abs(r.left - A.x);
  switch (Math.min(e, n, s, C)) {
    case C:
      return "left";
    case s:
      return "right";
...
function A8(A) {
  const { top: r, right: e, bottom: n, left: s } = A;
  return [
    { x: s, y: r },
    { x: e, y: r },
    { x: e, y: n },
...
function r8(A, r) {
  const { x: e, y: n } = A;
  let s = !1;
  for (let C = 0, o = r.length - 1; C < r.length; o = C++) {
    const a = r[C], i = r[o], l = a.x, c = a.y, B = i.x, u = i.y;
    c > n != u > n && e < (B - l) * (n - c) / (u - c) + l && (s = !s);
  }
  return s;
}
function e8(A) {
  const r = A.slice();
  return r.sort((e, n) => e.x < n.x ? -1 : e.x > n.x ? 1 : e.y < n.y ? -1 : e.y > n.y ? 1 : 0), t8(r);
}
function t8(A) {
  ...
  for (let n = 0; n < A.length; n++) {
    const s = A[n];
    for (; r.length >= 2; ) {
      const C = r[r.length - 1], o = r[r.length - 2];
      if ((C.x - o.x) * (s.y - o.y) >= (C.y - o.y) * (s.x - o.x)) r.pop();
      else break;
    }
    r.push(s);
  }
  ...
  for (let n = A.length - 1; n >= 0; n--) {
    const s = A[n];
    for (; e.length >= 2; ) {
      const C = e[e.length - 1], o = e[e.length - 2];
      if ((C.x - o.x) * (s.y - o.y) >= (C.y - o.y) * (s.x - o.x)) e.pop();
      else break;
    }
    e.push(s);
  }
...
var n8 = l5, s8 = i5, C8 = c5, o8 = B5, h5 = u5;
const a8 = n8, v4 = s8, M4 = C8, i4 = _(({ className: A, sideOffset: r = 4, ...e }, n) => /* @__PURE__ */ t.jsx(o8, { children: /* @__PURE__ */ t.jsx("div", { className: $6, children: /* @__PURE__ */ t.jsx(
  h5,
  {
    ref: n,
    className: b1(
...
i4.displayName = h5.displayName;
var Q5 = "Toggle", y2 = _((A, r) => {
  const { pressed: e, defaultPressed: n, onPressedChange: s, ...C } = A, [o, a] = R1({
    prop: e,
    onChange: s,
    defaultProp: n ?? !1,
    caller: Q5
...
y2.displayName = Q5;
var p5 = y2, XA = "ToggleGroup", [U5] = I2(XA, [
  X3
]), w5 = X3(), O2 = fA.forwardRef((A, r) => {
  const { type: e, ...n } = A;
  if (e === "single") {
    const s = n;
    return /* @__PURE__ */ t.jsx(l8, { ...s, ref: r });
  }
  if (e === "multiple") {
    const s = n;
    return /* @__PURE__ */ t.jsx(i8, { ...s, ref: r });
  }
  throw new Error(`Missing prop \`type\` expected on \`${XA}\``);
});
O2.displayName = XA;
var [g5, E5] = U5(XA), l8 = fA.forwardRef((A, r) => {
  const {
    value: e,
    defaultValue: n,
    onValueChange: s = () => {
  ...
  return /* @__PURE__ */ t.jsx(
    g5,
    {
      ...
      type: "single",
      value: fA.useMemo(() => o ? [o] : [], [o]),
      onItemActivate: a,
      onItemDeactivate: fA.useCallback(() => a(""), [a]),
      children: /* @__PURE__ */ t.jsx(F5, { ...C, ref: r })
    }
  );
}), i8 = fA.forwardRef((A, r) => {
  const {
    value: e,
    defaultValue: n,
    onValueChange: s = () => {
...
O2.displayName = XA;
var [c8, B8] = U5(XA), F5 = fA.forwardRef(
  (A, r) => {
    const {
      ...
      loop: a = !0,
      ...i
    } = A, l = w5(e), c = B7(o), B = { role: "group", dir: c, ...i };
    return /* @__PURE__ */ t.jsx(c8, { scope: e, rovingFocus: s, disabled: n, children: s ? /* @__PURE__ */ t.jsx(
      u7,
      {
        asChild: !0,
        ...l,
        ...
        dir: c,
        loop: a,
        children: /* @__PURE__ */ t.jsx(mA.div, { ...B, ref: r })
      }
    ) : /* @__PURE__ */ t.jsx(mA.div, { ...B, ref: r }) });
  }
), w1 = "ToggleGroupItem", x5 = fA.forwardRef(
  (A, r) => {
    const e = E5(w1, A.__scopeToggleGroup), n = B8(w1, A.__scopeToggleGroup), s = w5(A.__scopeToggleGroup), C = e.value.includes(A.value), o = n.disabled || A.disabled, a = { ...A, pressed: C, disabled: o }, i = fA.useRef(null);
    return n.rovingFocus ? /* @__PURE__ */ t.jsx(
      c7,
      {
        ...
        active: C,
        ref: i,
        children: /* @__PURE__ */ t.jsx(t3, { ...a, ref: r })
      }
    ) : /* @__PURE__ */ t.jsx(t3, { ...a, ref: r });
  }
);
x5.displayName = w1;
var t3 = fA.forwardRef(
  (A, r) => {
    const { __scopeToggleGroup: e, value: n, ...s } = A, C = E5(w1, e), o = { role: "radio", "aria-checked": A.pressed, "aria-pressed": void 0 }, a = C.type === "single" ? o : void 0;
    return /* @__PURE__ */ t.jsx(
      y2,
      {
        ...a,
        ...
        ref: r,
        onPressedChange: (i) => {
          i ? C.onItemActivate(n) : C.onItemDeactivate(n);
        }
      }
    );
  }
...
), u8 = _(({ className: A, variant: r, size: e, ...n }, s) => /* @__PURE__ */ t.jsx(
  p5,
  {
    ref: s,
    className: b1(M5({ variant: r, size: e, className: A })),
    ...n
  }
));
u8.displayName = p5.displayName;
const N5 = V3({
  size: "default",
  variant: "default"
}), o2 = _(({ className: A, variant: r, size: e, children: n, ...s }, C) => /* @__PURE__ */ t.jsx(
  H5,
  {
    ref: C,
    className: b1("inline-flex items-center justify-center gap-0.5 bg-gray-100 p-0.5 rounded-md dark:bg-gray-925/70", A),
    ...s,
    children: /* @__PURE__ */ t.jsx(N5.Provider, { value: { variant: r, size: e }, children: n })
  }
));
o2.displayName = H5.displayName;
const c4 = _(({ className: A, children: r, variant: e, size: n, ...s }, C) => {
  const o = N2(N5);
  return /* @__PURE__ */ t.jsx(
    v5,
    {
...
c4.displayName = v5.displayName;
const a2 = ({ className: A = "", style: r }) => /* @__PURE__ */ t.jsxs("svg", { className: A, fill: "none", height: "574", style: r, viewBox: "0 0 572 574", width: "572", xmlns: "http://www.w3.org/2000/svg", children: [
...
***************************************************************************** */
var l2 = function(A, r) {
  return l2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, n) {
    e.__proto__ = n;
  } || function(e, n) {
...
var g1 = function() {
  return g1 = Object.assign || function(r) {
...
function aA(A, r, e, n) {
  return new (e || (e = Promise))(function(s, C) {
    ...
    function i(l) {
      l.done ? s(l.value) : new e(function(c) {
        c(l.value);
      }).then(o, a);
    }
    i((n = n.apply(A, [])).next());
...
function CA(A, r) {
  ...
  function i(l) {
    ...
    for (; e; ) try {
      if (n = 1, s && (C = l[0] & 2 ? s.return : l[0] ? s.throw || ((C = s.return) && C.call(s), 0) : s.next) && !(C = C.call(s, l[1])).done) return C;
      switch (s = 0, C && (l = [l[0] & 2, C.value]), l[0]) {
        ...
        case 7:
          ...
          continue;
        default:
          if (C = e.trys, !(C = C.length > 0 && C[C.length - 1]) && (l[0] === 6 || l[0] === 2)) {
            e = 0;
            continue;
          }
          ...
          if (l[0] === 6 && e.label < C[1]) {
            e.label = C[1], C = l;
            break;
          }
          if (C && e.label < C[2]) {
            e.label = C[2], e.ops.push(l);
            break;
          }
...
var zA = (
  ...
  function() {
    function A(r, e, n, s) {
      this.left = r, this.top = e, this.width = n, this.height = s;
    }
    return A.prototype.add = function(r, e, n, s) {
      return new A(this.left + r, this.top + e, this.width + n, this.height + s);
    }, A.fromClientRect = function(r) {
      return new A(r.left, r.top, r.width, r.height);
    }, A;
  }()
), S2 = function(A) {
  return zA.fromClientRect(A.getBoundingClientRect());
}, h8 = function(A) {
  var r = A.body, e = A.documentElement;
  if (!r || !e)
    throw new Error("Unable to get document size");
  var n = Math.max(Math.max(r.scrollWidth, e.scrollWidth), Math.max(r.offsetWidth, e.offsetWidth), Math.max(r.clientWidth, e.clientWidth)), s = Math.max(Math.max(r.scrollHeight, e.scrollHeight), Math.max(r.offsetHeight, e.offsetHeight), Math.max(r.clientHeight, e.clientHeight));
  return new zA(0, 0, n, s);
}, y1 = function(A) {
  for (var r = [], e = 0, n = A.length; e < n; ) {
    var s = A.charCodeAt(e++);
    if (s >= 55296 && s <= 56319 && e < n) {
      var C = A.charCodeAt(e++);
      (C & 64512) === 56320 ? r.push(((s & 1023) << 10) + (C & 1023) + 65536) : (r.push(s), e--);
    } else
      r.push(s);
  }
  return r;
  ...
  for (var n = [], s = -1, C = ""; ++s < e; ) {
    var o = A[s];
    o <= 65535 ? n.push(o) : (o -= 65536, n.push((o >> 10) + 55296, o % 1024 + 56320)), (s + 1 === e || n.length > 16384) && (C += String.fromCharCode.apply(String, n), n.length = 0);
  }
  return C;
}, n3 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Z4 = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
for (var A1 = 0; A1 < n3.length; A1++)
  Z4[n3.charCodeAt(A1)] = A1;
var Q8 = function(A) {
  var r = A.length * 0.75, e = A.length, n, s = 0, C, o, a, i;
  A[A.length - 1] === "=" && (r--, A[A.length - 2] === "=" && r--);
  var l = typeof ArrayBuffer < "u" && typeof Uint8Array < "u" && typeof Uint8Array.prototype.slice < "u" ? new ArrayBuffer(r) : new Array(r), c = Array.isArray(l) ? l : new Uint8Array(l);
  for (n = 0; n < e; n += 4)
    C = Z4[A.charCodeAt(n)], o = Z4[A.charCodeAt(n + 1)], a = Z4[A.charCodeAt(n + 2)], i = Z4[A.charCodeAt(n + 3)], c[s++] = C << 2 | o >> 4, c[s++] = (o & 15) << 4 | a >> 2, c[s++] = (a & 3) << 6 | i & 63;
  return l;
}, p8 = function(A) {
  ...
  return e;
}, r4 = 5, D2 = 11, P1 = 2, w8 = D2 - r4, m5 = 65536 >> r4, g8 = 1 << r4, X1 = g8 - 1, E8 = 1024 >> r4, F8 = m5 + E8, x8 = F8, H8 = 32, v8 = x8 + H8, M8 = 65536 >> D2, N8 = 1 << w8, m8 = N8 - 1, s3 = function(A, r, e) {
  ...
  var r = Q8(A), e = Array.isArray(r) ? U8(r) : new Uint32Array(r), n = Array.isArray(r) ? p8(r) : new Uint16Array(r), s = 24, C = s3(n, s / 2, e[4] / 2), o = e[5] === 2 ? s3(n, (s + e[4]) / 2) : I8(e, Math.ceil((s + e[4]) / 4));
  return new R8(e[0], e[1], e[2], e[3], C, o);
}, R8 = (
  /** @class */
  function() {
    function A(r, e, n, s, C, o) {
      this.initialValue = r, this.errorValue = e, this.highStart = n, this.highValueIndex = s, this.index = C, this.data = o;
    }
    return A.prototype.get = function(r) {
      var e;
      if (r >= 0) {
        if (r < 55296 || r > 56319 && r <= 65535)
          return e = this.index[r >> r4], e = (e << P1) + (r & X1), this.data[e];
        if (r <= 65535)
          return e = this.index[m5 + (r - 55296 >> r4)], e = (e << P1) + (r & X1), this.data[e];
        if (r < this.highStart)
          return e = v8 - M8 + (r >> D2), e = this.index[e], e += r >> r4 & m8, e = this.index[e], e = (e << P1) + (r & X1), this.data[e];
        if (r <= 1114111)
  ...
  return 0;
}, z8 = function(A, r, e, n, s) {
  if (e[n] === 0)
    return R;
  var C = n - 1;
  if (Array.isArray(s) && s[C] === !0)
    return R;
  var o = C - 1, a = C + 1, i = r[C], l = o >= 0 ? r[o] : 0, c = r[a];
  if (i === I5 && c === K5)
    return R;
  if (Q2.indexOf(i) !== -1)
    return j5;
  if (Q2.indexOf(c) !== -1 || O5.indexOf(c) !== -1)
    return R;
  if (u3(C, r) === R5)
    return e1;
  if (y5.get(A[C]) === b5 && (c === _A || c === I4 || c === K4) || i === o3 || c === o3 || i === a3 || [DA, i2, j4].indexOf(i) === -1 && c === a3 || [r1, N4, i3, n4, s4].indexOf(c) !== -1 || u3(C, r) === m4 || q1(k1, m4, C, r) || q1([r1, N4], B2, C, r) || q1(l3, l3, C, r))
    return R;
  if (i === DA)
    return e1;
  if (i === k1 || c === k1)
  ...
  if (c === c2 || i === c2)
    return e1;
  if ([i2, j4, B2].indexOf(c) !== -1 || i === O8 || l === d2 && G8.indexOf(i) !== -1 || i === s4 && c === d2 || c === W1 && hA.concat(W1, i3, sA, _A, I4, K4).indexOf(i) !== -1 || hA.indexOf(c) !== -1 && i === sA || hA.indexOf(i) !== -1 && c === sA || i === O4 && [_A, I4, K4].indexOf(c) !== -1 || [_A, I4, K4].indexOf(i) !== -1 && c === y4 || hA.indexOf(i) !== -1 && c3.indexOf(c) !== -1 || c3.indexOf(i) !== -1 && hA.indexOf(c) !== -1 || // (PR | PO) × ( OP | HY )? NU
  [O4, y4].indexOf(i) !== -1 && (c === sA || [m4, j4].indexOf(c) !== -1 && r[a + 1] === sA) || // ( OP | HY ) × NU
  [m4, j4].indexOf(i) !== -1 && c === sA || // NU ×	(NU | SY | IS)
  i === sA && [sA, s4, n4].indexOf(c) !== -1)
    return R;
  if ([sA, s4, n4, r1, N4].indexOf(c) !== -1)
    for (var B = C; B >= 0; ) {
      var u = r[B];
      if (u === sA)
        return R;
      if ([s4, n4].indexOf(u) !== -1)
        B--;
      else
        break;
    }
  if ([O4, y4].indexOf(c) !== -1)
    for (var B = [r1, N4].indexOf(i) !== -1 ? o : C; B >= 0; ) {
      var u = r[B];
      if (u === sA)
        return R;
      if ([s4, n4].indexOf(u) !== -1)
  ...
  if (h2 === i && [h2, h1, u2, f2].indexOf(c) !== -1 || [h1, u2].indexOf(i) !== -1 && [h1, Q1].indexOf(c) !== -1 || [Q1, f2].indexOf(i) !== -1 && c === Q1 || B3.indexOf(i) !== -1 && [W1, y4].indexOf(c) !== -1 || B3.indexOf(c) !== -1 && i === O4 || hA.indexOf(i) !== -1 && hA.indexOf(c) !== -1 || i === n4 && hA.indexOf(c) !== -1 || hA.concat(sA).indexOf(i) !== -1 && c === m4 || hA.concat(sA).indexOf(c) !== -1 && i === N4)
    return R;
  if (i === J1 && c === J1) {
    for (var h = e[C], U = 1; h > 0 && (h--, r[h] === J1); )
      U++;
    if (U % 2 !== 0)
      return R;
  }
  return i === I4 && c === K4 ? R : e1;
}, P8 = function(A, r) {
  r || (r = { lineBreak: "normal", wordBreak: "normal" });
  var e = V8(A, r.lineBreak), n = e[0], s = e[1], C = e[2];
  (r.wordBreak === "break-all" || r.wordBreak === "break-word") && (s = s.map(function(a) {
    return [sA, qA, Z5].indexOf(a) !== -1 ? _A : a;
  }));
  var o = r.wordBreak === "keep-all" ? C.map(function(a, i) {
    return a && A[i] >= 19968 && A[i] <= 40959;
  }) : void 0;
  return [n, s, o];
}, X8 = (
  /** @class */
  function() {
    function A(r, e, n, s) {
      this.codePoints = r, this.required = e === j5, this.start = n, this.end = s;
    }
  ...
  var e = y1(A), n = P8(e, r), s = n[0], C = n[1], o = n[2], a = e.length, i = 0, l = 0;
  return {
    next: function() {
      if (l >= a)
        return { done: !0, value: null };
      for (var c = R; l < a && (c = z8(e, C, s, ++l, o)) === R; )
        ;
      if (c !== R || l === a) {
        var B = new X8(e, c, i, l);
        return i = l, { value: B, done: !1 };
      }
      return { done: !0, value: null };
    }
  };
...
var k8 = 1, J8 = 2, Y4 = 4, f3 = 8, E1 = 10, d3 = 47, T4 = 92, q8 = 9, Y8 = 32, t1 = 34, R4 = 61, _8 = 35, $8 = 36, A9 = 37, n1 = 39, s1 = 40, b4 = 41, r9 = 95, oA = 45, e9 = 33, t9 = 60, n9 = 62, s9 = 64, C9 = 91, o9 = 93, a9 = 61, l9 = 123, C1 = 63, i9 = 125, h3 = 124, c9 = 126, B9 = 128, Q3 = 65533, Y1 = 42, $A = 43, u9 = 44, f9 = 58, d9 = 59, X4 = 46, h9 = 0, Q9 = 8, p9 = 11, U9 = 14, w9 = 31, g9 = 127, QA = -1, S5 = 48, D5 = 97, T5 = 101, E9 = 102, F9 = 117, x9 = 122, L5 = 65, G5 = 69, V5 = 70, H9 = 85, v9 = 90, Y = function(A) {
  return A >= S5 && A <= 57;
}, M9 = function(A) {
  return A >= 55296 && A <= 57343;
}, C4 = function(A) {
  return Y(A) || A >= L5 && A <= V5 || A >= D5 && A <= E9;
}, N9 = function(A) {
  return A >= D5 && A <= x9;
}, m9 = function(A) {
  return A >= L5 && A <= v9;
  ...
  return A === E1 || A === q8 || A === Y8;
}, F1 = function(A) {
  return I9(A) || K9(A) || A === r9;
}, p3 = function(A) {
  return F1(A) || Y(A) || A === oA;
}, R9 = function(A) {
  return A >= h9 && A <= Q9 || A === p9 || A >= U9 && A <= w9 || A === g9;
}, yA = function(A, r) {
  return A !== T4 ? !1 : r !== E1;
}, a1 = function(A, r, e) {
  return A === oA ? F1(r) || yA(r, e) : F1(A) ? !0 : !!(A === T4 && yA(A, r));
}, _1 = function(A, r, e) {
  return A === $A || A === oA ? Y(r) ? !0 : r === X4 && Y(e) : Y(A === X4 ? r : A);
}, b9 = function(A) {
  var r = 0, e = 1;
  (A[r] === $A || A[r] === oA) && (A[r] === oA && (e = -1), r++);
  for (var n = []; Y(A[r]); )
    n.push(A[r++]);
  var s = n.length ? parseInt(T.apply(void 0, n), 10) : 0;
  A[r] === X4 && r++;
  for (var C = []; Y(A[r]); )
    C.push(A[r++]);
  var o = C.length, a = o ? parseInt(T.apply(void 0, C), 10) : 0;
  (A[r] === G5 || A[r] === T5) && r++;
  var i = 1;
  (A[r] === $A || A[r] === oA) && (A[r] === oA && (i = -1), r++);
  for (var l = []; Y(A[r]); )
    l.push(A[r++]);
  var c = l.length ? parseInt(T.apply(void 0, l), 10) : 0;
  return e * (s + a * Math.pow(10, -o)) * Math.pow(10, i * c);
}, Z9 = {
  type: f.LEFT_PARENTHESIS_TOKEN
}, j9 = {
  type: f.RIGHT_PARENTHESIS_TOKEN
}, y9 = { type: f.COMMA_TOKEN }, O9 = { type: f.SUFFIX_MATCH_TOKEN }, S9 = { type: f.PREFIX_MATCH_TOKEN }, D9 = { type: f.COLUMN_TOKEN }, T9 = { type: f.DASH_MATCH_TOKEN }, L9 = { type: f.INCLUDE_MATCH_TOKEN }, G9 = {
  type: f.LEFT_CURLY_BRACKET_TOKEN
}, V9 = {
  type: f.RIGHT_CURLY_BRACKET_TOKEN
}, z9 = { type: f.SUBSTRING_MATCH_TOKEN }, l1 = { type: f.BAD_URL_TOKEN }, P9 = { type: f.BAD_STRING_TOKEN }, X9 = { type: f.CDO_TOKEN }, W9 = { type: f.CDC_TOKEN }, k9 = { type: f.COLON_TOKEN }, J9 = { type: f.SEMICOLON_TOKEN }, q9 = {
  type: f.LEFT_SQUARE_BRACKET_TOKEN
}, Y9 = {
  type: f.RIGHT_SQUARE_BRACKET_TOKEN
}, _9 = { type: f.WHITESPACE_TOKEN }, p2 = { type: f.EOF_TOKEN }, z5 = (
  /** @class */
  function() {
    function A() {
      this._value = [];
    ...
    return A.prototype.write = function(r) {
      this._value = this._value.concat(y1(r));
    }, A.prototype.read = function() {
      for (var r = [], e = this.consumeToken(); e !== p2; )
      ...
      switch (r) {
        case t1:
          return this.consumeStringToken(t1);
        case _8:
          var e = this.peekCodePoint(0), n = this.peekCodePoint(1), s = this.peekCodePoint(2);
          if (p3(e) || yA(n, s)) {
            var C = a1(e, n, s) ? J8 : k8, o = this.consumeName();
            return { type: f.HASH_TOKEN, value: o, flags: C };
          }
          break;
        case $8:
          if (this.peekCodePoint(0) === R4)
            return this.consumeCodePoint(), O9;
          break;
        case n1:
          return this.consumeStringToken(n1);
        case s1:
          return Z9;
        case b4:
          return j9;
        case Y1:
          if (this.peekCodePoint(0) === R4)
            return this.consumeCodePoint(), z9;
          break;
        case $A:
          if (_1(r, this.peekCodePoint(0), this.peekCodePoint(1)))
            return this.reconsumeCodePoint(r), this.consumeNumericToken();
          break;
        case u9:
          return y9;
        case oA:
          var a = r, i = this.peekCodePoint(0), l = this.peekCodePoint(1);
          if (_1(a, i, l))
            return this.reconsumeCodePoint(r), this.consumeNumericToken();
          if (a1(a, i, l))
            return this.reconsumeCodePoint(r), this.consumeIdentLikeToken();
          if (i === oA && l === n9)
            return this.consumeCodePoint(), this.consumeCodePoint(), W9;
          break;
        case X4:
          if (_1(r, this.peekCodePoint(0), this.peekCodePoint(1)))
            return this.reconsumeCodePoint(r), this.consumeNumericToken();
          break;
        case d3:
          if (this.peekCodePoint(0) === Y1)
            for (this.consumeCodePoint(); ; ) {
              var c = this.consumeCodePoint();
              if (c === Y1 && (c = this.consumeCodePoint(), c === d3))
        ...
        case d9:
          return J9;
        case t9:
          if (this.peekCodePoint(0) === e9 && this.peekCodePoint(1) === oA && this.peekCodePoint(2) === oA)
            return this.consumeCodePoint(), this.consumeCodePoint(), X9;
          break;
        case s9:
          var B = this.peekCodePoint(0), u = this.peekCodePoint(1), h = this.peekCodePoint(2);
          if (a1(B, u, h)) {
        ...
        case a9:
          if (this.peekCodePoint(0) === R4)
            return this.consumeCodePoint(), S9;
          break;
        case l9:
          return G9;
        case i9:
        ...
        case H9:
          ...
          return U === $A && (C4(w) || w === C1) && (this.consumeCodePoint(), this.consumeUnicodeRangeToken()), this.reconsumeCodePoint(r), this.consumeIdentLikeToken();
        case h3:
          if (this.peekCodePoint(0) === R4)
            return this.consumeCodePoint(), T9;
          if (this.peekCodePoint(0) === h3)
            return this.consumeCodePoint(), D9;
          break;
        case c9:
          if (this.peekCodePoint(0) === R4)
            return this.consumeCodePoint(), L9;
          break;
        case QA:
          return p2;
      }
      return o1(r) ? (this.consumeWhiteSpace(), _9) : Y(r) ? (this.reconsumeCodePoint(r), this.consumeNumericToken()) : F1(r) ? (this.reconsumeCodePoint(r), this.consumeIdentLikeToken()) : { type: f.DELIM_TOKEN, value: T(r) };
      ...
      for (var r = [], e = this.consumeCodePoint(); C4(e) && r.length < 6; )
        r.push(e), e = this.consumeCodePoint();
      for (var n = !1; e === C1 && r.length < 6; )
        r.push(e), e = this.consumeCodePoint(), n = !0;
      if (n) {
        var s = parseInt(T.apply(void 0, r.map(function(i) {
          return i === C1 ? S5 : i;
        })), 16), C = parseInt(T.apply(void 0, r.map(function(i) {
          return i === C1 ? V5 : i;
        })), 16);
        return { type: f.UNICODE_RANGE_TOKEN, start: s, end: C };
      }
      var o = parseInt(T.apply(void 0, r), 16);
      if (this.peekCodePoint(0) === oA && C4(this.peekCodePoint(1))) {
        this.consumeCodePoint(), e = this.consumeCodePoint();
        for (var a = []; C4(e) && a.length < 6; )
          a.push(e), e = this.consumeCodePoint();
        var C = parseInt(T.apply(void 0, a), 16);
        return { type: f.UNICODE_RANGE_TOKEN, start: o, end: C };
      } else
        return { type: f.UNICODE_RANGE_TOKEN, start: o, end: o };
    }, A.prototype.consumeIdentLikeToken = function() {
      var r = this.consumeName();
      return r.toLowerCase() === "url" && this.peekCodePoint(0) === s1 ? (this.consumeCodePoint(), this.consumeUrlToken()) : this.peekCodePoint(0) === s1 ? (this.consumeCodePoint(), { type: f.FUNCTION_TOKEN, value: r }) : { type: f.IDENT_TOKEN, value: r };
      ...
      if (e === n1 || e === t1) {
        ...
        return n.type === f.STRING_TOKEN && (this.consumeWhiteSpace(), this.peekCodePoint(0) === QA || this.peekCodePoint(0) === b4) ? (this.consumeCodePoint(), { type: f.URL_TOKEN, value: n.value }) : (this.consumeBadUrlRemnants(), l1);
      }
      for (; ; ) {
        var s = this.consumeCodePoint();
        if (s === QA || s === b4)
          return { type: f.URL_TOKEN, value: T.apply(void 0, r) };
        if (o1(s))
          return this.consumeWhiteSpace(), this.peekCodePoint(0) === QA || this.peekCodePoint(0) === b4 ? (this.consumeCodePoint(), { type: f.URL_TOKEN, value: T.apply(void 0, r) }) : (this.consumeBadUrlRemnants(), l1);
        if (s === t1 || s === n1 || s === s1 || R9(s))
          return this.consumeBadUrlRemnants(), l1;
        if (s === T4)
          if (yA(s, this.peekCodePoint(0)))
      ...
      for (; ; ) {
        ...
        if (r === b4 || r === QA)
          return;
        yA(r, this.peekCodePoint(0)) && this.consumeEscapedCodePoint();
      }
    }, A.prototype.consumeStringSlice = function(r) {
      for (var e = 6e4, n = ""; r > 0; ) {
        var s = Math.min(e, r);
        n += T.apply(void 0, this._value.splice(0, s)), r -= s;
      }
      ...
      do {
        var s = this._value[n];
        if (s === QA || s === void 0 || s === r)
          return e += this.consumeStringSlice(n), { type: f.STRING_TOKEN, value: e };
        if (s === E1)
          return this._value.splice(0, n), P9;
        if (s === T4) {
          var C = this._value[n + 1];
          C !== QA && C !== void 0 && (C === E1 ? (e += this.consumeStringSlice(n), n = -1, this._value.shift()) : yA(s, C) && (e += this.consumeStringSlice(n), e += T(this.consumeEscapedCodePoint()), n = -1));
        }
        n++;
      } while (!0);
    }, A.prototype.consumeNumber = function() {
      var r = [], e = Y4, n = this.peekCodePoint(0);
      for ((n === $A || n === oA) && r.push(this.consumeCodePoint()); Y(this.peekCodePoint(0)); )
        r.push(this.consumeCodePoint());
      n = this.peekCodePoint(0);
      var s = this.peekCodePoint(1);
      if (n === X4 && Y(s))
        for (r.push(this.consumeCodePoint(), this.consumeCodePoint()), e = f3; Y(this.peekCodePoint(0)); )
          r.push(this.consumeCodePoint());
      n = this.peekCodePoint(0), s = this.peekCodePoint(1);
      var C = this.peekCodePoint(2);
      if ((n === G5 || n === T5) && ((s === $A || s === oA) && Y(C) || Y(s)))
        for (r.push(this.consumeCodePoint(), this.consumeCodePoint()), e = f3; Y(this.peekCodePoint(0)); )
          r.push(this.consumeCodePoint());
      return [b9(r), e];
    }, A.prototype.consumeNumericToken = function() {
      var r = this.consumeNumber(), e = r[0], n = r[1], s = this.peekCodePoint(0), C = this.peekCodePoint(1), o = this.peekCodePoint(2);
      if (a1(s, C, o)) {
        var a = this.consumeName();
        return { type: f.DIMENSION_TOKEN, number: e, flags: n, unit: a };
      }
      return s === A9 ? (this.consumeCodePoint(), { type: f.PERCENTAGE_TOKEN, number: e, flags: n }) : { type: f.NUMBER_TOKEN, number: e, flags: n };
    }, A.prototype.consumeEscapedCodePoint = function() {
      var r = this.consumeCodePoint();
      if (C4(r)) {
        for (var e = T(r); C4(this.peekCodePoint(0)) && e.length < 6; )
          e += T(this.consumeCodePoint());
        o1(this.peekCodePoint(0)) && this.consumeCodePoint();
        var n = parseInt(e, 16);
        return n === 0 || M9(n) || n > 1114111 ? Q3 : n;
      }
      return r === QA ? Q3 : r;
  ...
  function() {
    ...
    return A.create = function(r) {
      ...
      for (var r = this.consumeToken(); r.type === f.WHITESPACE_TOKEN; )
        r = this.consumeToken();
      if (r.type === f.EOF_TOKEN)
        throw new SyntaxError("Error parsing CSS component value, unexpected EOF");
      this.reconsumeToken(r);
      var e = this.consumeComponentValue();
      do
        r = this.consumeToken();
      while (r.type === f.WHITESPACE_TOKEN);
      if (r.type === f.EOF_TOKEN)
        return e;
  ...
  return A.forEach(function(n) {
    if (n.type === f.COMMA_TOKEN) {
      if (e.length === 0)
        throw new Error("Error parsing function args, zero tokens for arg");
      r.push(e), e = [];
      return;
    }
    n.type !== f.WHITESPACE_TOKEN && e.push(n);
  }), e.length && r.push(e), r;
}, Ar = function(A, r) {
  return r === f.LEFT_CURLY_BRACKET_TOKEN && A.type === f.RIGHT_CURLY_BRACKET_TOKEN || r === f.LEFT_SQUARE_BRACKET_TOKEN && A.type === f.RIGHT_SQUARE_BRACKET_TOKEN ? !0 : r === f.LEFT_PARENTHESIS_TOKEN && A.type === f.RIGHT_PARENTHESIS_TOKEN;
}, PA = function(A) {
  ...
  var n = A[0], s = A[1];
  return [S(n, r), S(typeof s < "u" ? s : n, e)];
}, S = function(A, r) {
  ...
  return A.number;
}, W5 = "deg", k5 = "grad", J5 = "rad", q5 = "turn", O1 = {
  name: "angle",
  parse: function(A) {
  ...
  return A.type === f.DIMENSION_TOKEN && (A.unit === W5 || A.unit === k5 || A.unit === J5 || A.unit === q5);
}, _5 = function(A) {
  var r = A.filter(O).map(function(e) {
    return e.value;
  }).join(" ");
  switch (r) {
  ...
  parse: function(A) {
    ...
    if (A.type === f.HASH_TOKEN) {
      if (A.value.length === 3) {
        var e = A.value.substring(0, 1), n = A.value.substring(1, 2), s = A.value.substring(2, 3);
        return LA(parseInt(e + e, 16), parseInt(n + n, 16), parseInt(s + s, 16), 1);
      }
      if (A.value.length === 4) {
        var e = A.value.substring(0, 1), n = A.value.substring(1, 2), s = A.value.substring(2, 3), C = A.value.substring(3, 4);
        return LA(parseInt(e + e, 16), parseInt(n + n, 16), parseInt(s + s, 16), parseInt(C + C, 16) / 255);
      }
      if (A.value.length === 6) {
        var e = A.value.substring(0, 2), n = A.value.substring(2, 4), s = A.value.substring(4, 6);
        return LA(parseInt(e, 16), parseInt(n, 16), parseInt(s, 16), 1);
      }
      if (A.value.length === 8) {
        var e = A.value.substring(0, 2), n = A.value.substring(2, 4), s = A.value.substring(4, 6), C = A.value.substring(6, 8);
        return LA(parseInt(e, 16), parseInt(n, 16), parseInt(s, 16), parseInt(C, 16) / 255);
      }
    }
    if (A.type === f.IDENT_TOKEN) {
      var o = xA[A.value.toUpperCase()];
      if (typeof o < "u")
        return o;
    }
  ...
  var r = 255 & A, e = 255 & A >> 8, n = 255 & A >> 16, s = 255 & A >> 24;
  return r < 255 ? "rgba(" + s + "," + n + "," + e + "," + r / 255 + ")" : "rgb(" + s + "," + n + "," + e + ")";
}, LA = function(A, r, e, n) {
  return (A << 24 | r << 16 | e << 8 | Math.round(n * 255) << 0) >>> 0;
}, U3 = function(A, r) {
  if (A.type === f.NUMBER_TOKEN)
    return A.number;
  if (A.type === f.PERCENTAGE_TOKEN) {
    var e = r === 3 ? 1 : 255;
  ...
  var r = A.filter(U4);
  if (r.length === 3) {
    var e = r.map(U3), n = e[0], s = e[1], C = e[2];
    return LA(n, s, C, 1);
  }
  if (r.length === 4) {
    var o = r.map(U3), n = o[0], s = o[1], C = o[2], a = o[3];
    return LA(n, s, C, a);
  }
  return 0;
};
...
var g3 = function(A) {
  var r = A.filter(U4), e = r[0], n = r[1], s = r[2], C = r[3], o = (e.type === f.NUMBER_TOKEN ? BA(e.number) : O1.parse(e)) / (Math.PI * 2), a = L(n) ? n.number / 100 : 0, i = L(s) ? s.number / 100 : 0, l = typeof C < "u" && L(C) ? S(C, 1) : 1;
  if (a === 0)
    return LA(i * 255, i * 255, i * 255, 1);
  var c = i <= 0.5 ? i * (a + 1) : i + a - i * a, B = i * 2 - c, u = $1(B, c, o + 1 / 3), h = $1(B, c, o), U = $1(B, c, o - 1 / 3);
  return LA(u * 255, h * 255, U * 255, l);
}, rr = {
  hsl: g3,
  hsla: g3,
  rgb: w3,
...
var er = {
  ...
  parse: function(A) {
    return A.map(function(r) {
      if (O(r))
        switch (r.value) {
          case "padding-box":
            return dA.PADDING_BOX;
          case "content-box":
            return dA.CONTENT_BOX;
        }
      return dA.BORDER_BOX;
    });
  }
}, tr = {
  ...
  var r = NA.parse(A[0]), e = A[1];
  return e && L(e) ? { color: r, stop: e } : { color: r, stop: null };
}, E3 = function(A, r) {
  var e = A[0], n = A[A.length - 1];
  e.stop === null && (e.stop = J), n.stop === null && (n.stop = TA);
  for (var s = [], C = 0, o = 0; o < A.length; o++) {
    var a = A[o].stop;
    if (a !== null) {
      var i = S(a, r);
      i > C ? s.push(i) : s.push(C), C = i;
    } else
      s.push(null);
  }
  for (var l = null, o = 0; o < s.length; o++) {
    var c = s[o];
    if (c === null)
      l === null && (l = o);
    else if (l !== null) {
      for (var B = o - l, u = s[l - 1], h = (c - u) / (B + 1), U = 1; U <= B; U++)
        s[l + U - 1] = h * U;
      l = null;
    }
  }
  return A.map(function(w, p) {
    var Q = w.color;
    return { color: Q, stop: Math.max(Math.min(1, s[p] / r), 0) };
  });
}, nr = function(A, r, e) {
  var n = r / 2, s = e / 2, C = S(A[0], r) - n, o = s - S(A[1], e);
  return (Math.atan2(o, C) + Math.PI * 2) % (Math.PI * 2);
}, sr = function(A, r, e) {
  var n = typeof A == "number" ? A : nr(A, r, e), s = Math.abs(r * Math.sin(n)) + Math.abs(e * Math.cos(n)), C = r / 2, o = e / 2, a = s / 2, i = Math.sin(n - Math.PI / 2) * a, l = Math.cos(n - Math.PI / 2) * a;
  return [s, C - l, C + l, o - i, o + i];
}, uA = function(A, r) {
  return Math.sqrt(A * A + r * r);
}, F3 = function(A, r, e, n, s) {
  var C = [[0, 0], [0, r], [A, 0], [A, r]];
  return C.reduce(function(o, a) {
    var i = a[0], l = a[1], c = uA(e - i, n - l);
...
}, Cr = function(A, r, e, n, s) {
  var C = 0, o = 0;
  switch (A.size) {
    case k.CLOSEST_SIDE:
      A.shape === X.CIRCLE ? C = o = Math.min(Math.abs(r), Math.abs(r - n), Math.abs(e), Math.abs(e - s)) : A.shape === X.ELLIPSE && (C = Math.min(Math.abs(r), Math.abs(r - n)), o = Math.min(Math.abs(e), Math.abs(e - s)));
      break;
    case k.CLOSEST_CORNER:
      if (A.shape === X.CIRCLE)
        C = o = Math.min(uA(r, e), uA(r, e - s), uA(r - n, e), uA(r - n, e - s));
      else if (A.shape === X.ELLIPSE) {
        var a = Math.min(Math.abs(e), Math.abs(e - s)) / Math.min(Math.abs(r), Math.abs(r - n)), i = F3(n, s, r, e, !0), l = i[0], c = i[1];
        C = uA(l - r, (c - e) / a), o = a * C;
      }
      break;
    case k.FARTHEST_SIDE:
      A.shape === X.CIRCLE ? C = o = Math.max(Math.abs(r), Math.abs(r - n), Math.abs(e), Math.abs(e - s)) : A.shape === X.ELLIPSE && (C = Math.max(Math.abs(r), Math.abs(r - n)), o = Math.max(Math.abs(e), Math.abs(e - s)));
      break;
    case k.FARTHEST_CORNER:
      if (A.shape === X.CIRCLE)
        C = o = Math.max(uA(r, e), uA(r, e - s), uA(r - n, e), uA(r - n, e - s));
      else if (A.shape === X.ELLIPSE) {
        var a = Math.max(Math.abs(e), Math.abs(e - s)) / Math.max(Math.abs(r), Math.abs(r - n)), B = F3(n, s, r, e, !1), l = B[0], c = B[1];
        C = uA(l - r, (c - e) / a), o = a * C;
      }
      break;
  }
  return Array.isArray(A.size) && (C = S(A.size[0], n), o = A.size.length === 2 ? S(A.size[1], s) : C), [C, o];
}, or = function(A) {
  var r = BA(180), e = [];
  return UA(A).forEach(function(n, s) {
    if (s === 0) {
      var C = n[0];
      if (C.type === f.IDENT_TOKEN && C.value === "to") {
        r = _5(n);
        return;
      } else if (Y5(C)) {
        r = O1.parse(C);
    ...
    var o = S1(n);
    e.push(o);
  }), { angle: r, stops: e, type: tA.LINEAR_GRADIENT };
}, i1 = function(A) {
  var r = BA(180), e = [];
  return UA(A).forEach(function(n, s) {
    if (s === 0) {
      var C = n[0];
      if (C.type === f.IDENT_TOKEN && ["top", "left", "right", "bottom"].indexOf(C.value) !== -1) {
        r = _5(n);
        return;
      } else if (Y5(C)) {
        r = (O1.parse(C) + BA(270)) % BA(360);
        return;
      }
    }
    var o = S1(n);
  ...
  if (A.createRange) {
    ...
    if (e.getBoundingClientRect) {
      ...
      var s = e.getBoundingClientRect(), C = Math.round(s.height);
      if (A.body.removeChild(n), C === r)
        return !0;
    }
  }
  return !1;
  ...
  var s = new Image(), C = r.toDataURL();
  s.src = C;
  var o = w2(e, e, 0, 0, s);
  return n.fillStyle = "red", n.fillRect(0, 0, e, e), H3(o).then(function(a) {
    n.drawImage(a, 0, 0);
    var i = n.getImageData(0, 0, e, e).data;
    n.fillStyle = "red", n.fillRect(0, 0, e, e);
    var l = A.createElement("div");
    return l.style.backgroundImage = "url(" + C + ")", l.style.height = e + "px", x3(i) ? H3(w2(e, e, 0, 0, l)) : Promise.reject(!1);
  }).then(function(a) {
    return n.drawImage(a, 0, 0), x3(n.getImageData(0, 0, e, e).data);
  }).catch(function() {
    return !1;
  });
}, w2 = function(A, r, e, n, s) {
  var C = "http://www.w3.org/2000/svg", o = document.createElementNS(C, "svg"), a = document.createElementNS(C, "foreignObject");
  return o.setAttributeNS(null, "width", A.toString()), o.setAttributeNS(null, "height", r.toString()), a.setAttributeNS(null, "width", "100%"), a.setAttributeNS(null, "height", "100%"), a.setAttributeNS(null, "x", e.toString()), a.setAttributeNS(null, "y", n.toString()), a.setAttributeNS(null, "externalResourcesRequired", "true"), o.appendChild(a), a.appendChild(s), o;
}, H3 = function(A) {
  ...
  get SUPPORT_FOREIGNOBJECT_DRAWING() {
    var A = typeof Array.from == "function" && typeof window.fetch == "function" ? Br(document) : Promise.resolve(!1);
  ...
  function() {
    ...
    return A.prototype.addImage = function(r) {
      ...
      return this.has(r) || (Ur(r) || Qr(r)) && (this._cache[r] = this.loadImage(r)), e;
      ...
      return aA(this, void 0, void 0, function() {
        ...
        return CA(this, function(a) {
          switch (a.label) {
            case 0:
              return e = HA.isSameOrigin(r), n = !A2(r) && this._options.useCORS === !0 && cA.SUPPORT_CORS_IMAGES && !e, s = !A2(r) && !e && typeof this._options.proxy == "string" && cA.SUPPORT_CORS_XHR && !n, !e && this._options.allowTaint === !1 && !A2(r) && !s && !n ? [
                2
                /*return*/
              ] : (C = r, s ? [4, this.proxy(C)] : [3, 2]);
            case 1:
              C = a.sent(), a.label = 2;
            case 2:
              return z.getInstance(this.id).debug("Added image " + r.substring(0, 256)), [4, new Promise(function(i, l) {
                var c = new Image();
                c.onload = function() {
                  return i(c);
                }, c.onerror = l, (pr(C) || n) && (c.crossOrigin = "anonymous"), c.src = C, c.complete === !0 && setTimeout(function() {
                  return i(c);
      ...
      return new Promise(function(C, o) {
        var a = cA.SUPPORT_RESPONSE_TYPE ? "blob" : "text", i = new XMLHttpRequest();
        if (i.onload = function() {
          if (i.status === 200)
            ...
            o("Failed to proxy resource " + s + " with status code " + i.status);
        }, i.onerror = o, i.open("GET", n + "?url=" + encodeURIComponent(r) + "&responseType=" + a), a !== "text" && i instanceof XMLHttpRequest && (i.responseType = a), e._options.imageTimeout) {
          var l = e._options.imageTimeout;
          i.timeout = l, i.ontimeout = function() {
            return o("Timed out (" + l + "ms) proxying " + s);
          };
        }
        i.send();
      });
...
), fr = /^data:image\/svg\+xml/i, dr = /^data:image\/.*;base64,/i, hr = /^data:image\/.*/i, Qr = function(A) {
  return cA.SUPPORT_SVG_DRAWING || !wr(A);
}, A2 = function(A) {
  return hr.test(A);
}, pr = function(A) {
  return dr.test(A);
  ...
  return A.substr(-3).toLowerCase() === "svg" || fr.test(A);
}, gr = function(A) {
  var r = BA(180), e = [], n = tA.LINEAR_GRADIENT, s = X.CIRCLE, C = k.FARTHEST_CORNER, o = [];
  return UA(A).forEach(function(a, i) {
    var l = a[0];
    if (i === 0) {
      if (O(l) && l.value === "linear") {
        n = tA.LINEAR_GRADIENT;
        return;
      } else if (O(l) && l.value === "radial") {
        n = tA.RADIAL_GRADIENT;
        return;
      }
    }
    if (l.type === f.FUNCTION) {
      if (l.name === "from") {
        var c = NA.parse(l.values[0]);
        e.push({ stop: J, color: c });
      } else if (l.name === "to") {
        var c = NA.parse(l.values[0]);
        e.push({ stop: TA, color: c });
      } else if (l.name === "color-stop") {
        var B = l.values.filter(U4);
        if (B.length === 2) {
          var c = NA.parse(B[1]), u = B[0];
          g4(u) && e.push({
            stop: { type: f.PERCENTAGE_TOKEN, number: u.number * 100, flags: u.flags },
            color: c
          });
        }
      }
    ...
    stops: e,
    type: n
  } : { size: C, shape: s, stops: e, position: o, type: n };
}, $5 = "closest-side", A6 = "farthest-side", r6 = "closest-corner", e6 = "farthest-corner", t6 = "circle", n6 = "ellipse", s6 = "cover", C6 = "contain", Er = function(A) {
  var r = X.CIRCLE, e = k.FARTHEST_CORNER, n = [], s = [];
  return UA(A).forEach(function(C, o) {
    var a = !0;
    if (o === 0) {
      var i = !1;
      a = C.reduce(function(c, B) {
        if (i)
          if (O(B))
            switch (B.value) {
              case "center":
          ...
          else (L(B) || PA(B)) && s.push(B);
        else if (O(B))
          switch (B.value) {
            case t6:
              return r = X.CIRCLE, !1;
            case n6:
              return r = X.ELLIPSE, !1;
            case "at":
              return i = !0, !1;
            case $5:
              return e = k.CLOSEST_SIDE, !1;
            case s6:
            case A6:
              return e = k.FARTHEST_SIDE, !1;
            case C6:
            case r6:
              return e = k.CLOSEST_CORNER, !1;
            case e6:
              return e = k.FARTHEST_CORNER, !1;
          }
        else if (PA(B) || L(B))
  ...
  }), { size: e, shape: r, stops: n, position: s, type: tA.RADIAL_GRADIENT };
}, c1 = function(A) {
  var r = X.CIRCLE, e = k.FARTHEST_CORNER, n = [], s = [];
  return UA(A).forEach(function(C, o) {
    var a = !0;
    if (o === 0 ? a = C.reduce(function(l, c) {
      if (O(c))
        switch (c.value) {
          case "center":
            return s.push(G2), !1;
...
var Fr = function(A) {
  return A.type === tA.LINEAR_GRADIENT;
}, xr = function(A) {
  return A.type === tA.RADIAL_GRADIENT;
}, X;
(function(A) {
...
var V2 = {
  ...
  parse: function(A) {
    if (A.type === f.URL_TOKEN) {
      var r = { url: A.value, type: tA.URL };
      return HA.getInstance().addImage(A.value), r;
    }
    if (A.type === f.FUNCTION) {
      var e = o6[A.name];
      if (typeof e > "u")
...
function Hr(A) {
  return A.type !== f.FUNCTION || o6[A.name];
}
var o6 = {
  "linear-gradient": or,
  "-moz-linear-gradient": i1,
  "-ms-linear-gradient": i1,
  "-o-linear-gradient": i1,
  "-webkit-linear-gradient": i1,
  "radial-gradient": Er,
  "-moz-radial-gradient": c1,
  "-ms-radial-gradient": c1,
  "-o-radial-gradient": c1,
  "-webkit-radial-gradient": c1,
  "-webkit-gradient": gr
}, vr = {
  ...
  parse: function(A) {
    if (A.length === 0)
      return [];
    var r = A[0];
    return r.type === f.IDENT_TOKEN && r.value === "none" ? [] : A.filter(function(e) {
      return U4(e) && Hr(e);
    }).map(V2.parse);
  }
}, Mr = {
...
var mr = {
  ...
  parse: function(A) {
    return UA(A).map(function(r) {
      return r.filter(O).map(function(e) {
        return e.value;
      }).join(" ");
    }).map(Ir);
  }
...
}, br = D1("top"), Zr = D1("right"), jr = D1("bottom"), yr = D1("left"), T1 = function(A) {
  return {
    ...
    type: F.LIST,
    parse: function(r) {
      return X5(r.filter(L));
    }
  };
}, Or = T1("top-left"), Sr = T1("top-right"), Dr = T1("bottom-right"), Tr = T1("bottom-left"), w4;
(function(A) {
...
}, Lr = L1("top"), Gr = L1("right"), Vr = L1("bottom"), zr = L1("left"), G1 = function(A) {
  return {
    name: "border-" + A + "-width",
    initialValue: "0",
    type: F.VALUE,
    prefix: !1,
    parse: function(r) {
      return L2(r) ? r.number : 0;
    }
  };
}, Pr = G1("top"), Xr = G1("right"), Wr = G1("bottom"), kr = G1("left"), Jr = {
  name: "color",
  initialValue: "transparent",
  prefix: !1,
  type: F.TYPE_VALUE,
...
var _r = {
  ...
  type: F.VALUE,
  parse: function(A) {
    return A.type === f.IDENT_TOKEN && A.value === "normal" ? 0 : A.type === f.NUMBER_TOKEN || A.type === f.DIMENSION_TOKEN ? A.number : 0;
  }
}, x1;
(function(A) {
...
var Ae = {
  ...
  return O(A) && A.value === "normal" ? 1.2 * r : A.type === f.NUMBER_TOKEN ? r * A.number : L(A) ? S(A, r) : r;
}, te = {
  ...
  prefix: !1,
  parse: function(A) {
    return A.type === f.IDENT_TOKEN && A.value === "none" ? null : V2.parse(A);
  }
}, H1;
(function(A) {
  ...
  parse: function(A) {
    switch (A) {
      ...
      case "decimal":
        return d.DECIMAL;
      case "cjk-decimal":
        return d.CJK_DECIMAL;
      case "decimal-leading-zero":
        return d.DECIMAL_LEADING_ZERO;
      case "lower-roman":
        return d.LOWER_ROMAN;
      case "upper-roman":
        return d.UPPER_ROMAN;
      case "lower-greek":
        return d.LOWER_GREEK;
      case "lower-alpha":
        return d.LOWER_ALPHA;
      case "upper-alpha":
        return d.UPPER_ALPHA;
      case "arabic-indic":
        return d.ARABIC_INDIC;
      case "armenian":
        return d.ARMENIAN;
      case "bengali":
        return d.BENGALI;
      ...
      case "cjk-earthly-branch":
        return d.CJK_EARTHLY_BRANCH;
      case "cjk-heavenly-stem":
        return d.CJK_HEAVENLY_STEM;
      case "cjk-ideographic":
        return d.CJK_IDEOGRAPHIC;
      case "devanagari":
        return d.DEVANAGARI;
      case "ethiopic-numeric":
        return d.ETHIOPIC_NUMERIC;
      case "georgian":
        return d.GEORGIAN;
      case "gujarati":
        return d.GUJARATI;
      ...
      case "hiragana":
        return d.HIRAGANA;
      case "hiragana-iroha":
        return d.HIRAGANA_IROHA;
      case "japanese-formal":
        return d.JAPANESE_FORMAL;
      case "japanese-informal":
        return d.JAPANESE_INFORMAL;
      case "kannada":
        return d.KANNADA;
      case "katakana":
        return d.KATAKANA;
      case "katakana-iroha":
        return d.KATAKANA_IROHA;
      case "khmer":
        return d.KHMER;
      case "korean-hangul-formal":
        return d.KOREAN_HANGUL_FORMAL;
      case "korean-hanja-formal":
        return d.KOREAN_HANJA_FORMAL;
      case "korean-hanja-informal":
        return d.KOREAN_HANJA_INFORMAL;
      case "lao":
        return d.LAO;
      case "lower-armenian":
        return d.LOWER_ARMENIAN;
      case "malayalam":
        return d.MALAYALAM;
      case "mongolian":
        return d.MONGOLIAN;
      ...
      case "simp-chinese-formal":
        return d.SIMP_CHINESE_FORMAL;
      case "simp-chinese-informal":
        return d.SIMP_CHINESE_INFORMAL;
      case "tamil":
        return d.TAMIL;
      case "telugu":
        return d.TELUGU;
      ...
      case "trad-chinese-formal":
        return d.TRAD_CHINESE_FORMAL;
      case "trad-chinese-informal":
        return d.TRAD_CHINESE_INFORMAL;
      case "upper-armenian":
        return d.UPPER_ARMENIAN;
      case "disclosure-open":
        return d.DISCLOSURE_OPEN;
      case "disclosure-closed":
        return d.DISCLOSURE_CLOSED;
      case "none":
      default:
        return d.NONE;
    }
...
}, se = V1("top"), Ce = V1("right"), oe = V1("bottom"), ae = V1("left"), GA;
(function(A) {
...
var le = {
  ...
  type: F.LIST,
  parse: function(A) {
    return A.filter(O).map(function(r) {
      switch (r.value) {
        case "hidden":
          return GA.HIDDEN;
        case "scroll":
...
}, ce = z1("top"), Be = z1("right"), ue = z1("bottom"), fe = z1("left"), pA;
(function(A) {
...
var he = {
  ...
  prefix: !1,
  parse: function(A) {
    return A.length === 1 && U2(A[0], "none") ? [] : UA(A).map(function(r) {
      for (var e = {
        ...
        var C = r[s];
        PA(C) ? (n === 0 ? e.offsetX = C : n === 1 ? e.offsetY = C : e.blur = C, n++) : e.color = NA.parse(C);
      }
      return e;
    });
  }
...
var pe = {
  ...
  type: F.VALUE,
  parse: function(A) {
    if (A.type === f.IDENT_TOKEN && A.value === "none")
      return null;
    if (A.type === f.FUNCTION) {
      var r = Ee[A.name];
      if (typeof r > "u")
  ...
  var o = r[12], a = r[13];
  return r[14], r[15], r.length === 16 ? [e, n, s, C, o, a] : null;
}, Ee = {
  matrix: we,
  matrix3d: ge
}, v3 = {
...
var je = {
  ...
  parse: function(A) {
    if (A.length === 0)
      return [];
    var r = A[0];
    return r.type === f.IDENT_TOKEN && r.value === "none" ? [] : A;
  }
}, Oe = {
  ...
  parse: function(A) {
    if (A.length === 0)
      return null;
    var r = A[0];
    if (r.type === f.IDENT_TOKEN && r.value === "none")
      return null;
    for (var e = [], n = A.filter(P5), s = 0; s < n.length; s++) {
      var C = n[s], o = n[s + 1];
      if (C.type === f.IDENT_TOKEN) {
        var a = o && g4(o) ? o.number : 1;
        e.push({ counter: C.value, increment: a });
      }
    }
    return e;
  }
  ...
  parse: function(A) {
    if (A.length === 0)
      return [];
    for (var r = [], e = A.filter(P5), n = 0; n < e.length; n++) {
      var s = e[n], C = e[n + 1];
      if (O(s) && s.value !== "none") {
        var o = C && g4(C) ? C.number : 0;
        r.push({ counter: s.value, reset: o });
      }
    }
    return r;
  }
  ...
  parse: function(A) {
    ...
    for (var s = 0; s < n.length; s += 2) {
      var C = n[s].value, o = n[s + 1].value;
      e.push({ open: C, close: o });
    }
    return e;
  }
}, M3 = function(A, r, e) {
  ...
  parse: function(A) {
    return A.length === 1 && U2(A[0], "none") ? [] : UA(A).map(function(r) {
      for (var e = {
        ...
        var C = r[s];
        U2(C, "inset") ? e.inset = !0 : PA(C) ? (n === 0 ? e.offsetX = C : n === 1 ? e.offsetY = C : n === 2 ? e.blur = C : e.spread = C, n++) : e.color = NA.parse(C);
      }
      return e;
    });
  }
  ...
  function() {
    function A(r) {
      this.backgroundClip = g(er, r.backgroundClip), this.backgroundColor = g(tr, r.backgroundColor), this.backgroundImage = g(vr, r.backgroundImage), this.backgroundOrigin = g(Mr, r.backgroundOrigin), this.backgroundPosition = g(Nr, r.backgroundPosition), this.backgroundRepeat = g(mr, r.backgroundRepeat), this.backgroundSize = g(Kr, r.backgroundSize), this.borderTopColor = g(br, r.borderTopColor), this.borderRightColor = g(Zr, r.borderRightColor), this.borderBottomColor = g(jr, r.borderBottomColor), this.borderLeftColor = g(yr, r.borderLeftColor), this.borderTopLeftRadius = g(Or, r.borderTopLeftRadius), this.borderTopRightRadius = g(Sr, r.borderTopRightRadius), this.borderBottomRightRadius = g(Dr, r.borderBottomRightRadius), this.borderBottomLeftRadius = g(Tr, r.borderBottomLeftRadius), this.borderTopStyle = g(Lr, r.borderTopStyle), this.borderRightStyle = g(Gr, r.borderRightStyle), this.borderBottomStyle = g(Vr, r.borderBottomStyle), this.borderLeftStyle = g(zr, r.borderLeftStyle), this.borderTopWidth = g(Pr, r.borderTopWidth), this.borderRightWidth = g(Xr, r.borderRightWidth), this.borderBottomWidth = g(Wr, r.borderBottomWidth), this.borderLeftWidth = g(kr, r.borderLeftWidth), this.boxShadow = g(Te, r.boxShadow), this.color = g(Jr, r.color), this.display = g(qr, r.display), this.float = g(_r, r.cssFloat), this.fontFamily = g(Ke, r.fontFamily), this.fontSize = g(Re, r.fontSize), this.fontStyle = g(je, r.fontStyle), this.fontVariant = g(Ze, r.fontVariant), this.fontWeight = g(be, r.fontWeight), this.letterSpacing = g($r, r.letterSpacing), this.lineBreak = g(Ae, r.lineBreak), this.lineHeight = g(re, r.lineHeight), this.listStyleImage = g(te, r.listStyleImage), this.listStylePosition = g(ne, r.listStylePosition), this.listStyleType = g(g2, r.listStyleType), this.marginTop = g(se, r.marginTop), this.marginRight = g(Ce, r.marginRight), this.marginBottom = g(oe, r.marginBottom), this.marginLeft = g(ae, r.marginLeft), this.opacity = g(Ne, r.opacity);
      var e = g(le, r.overflow);
      this.overflowX = e[0], this.overflowY = e[e.length > 1 ? 1 : 0], this.overflowWrap = g(ie, r.overflowWrap), this.paddingTop = g(ce, r.paddingTop), this.paddingRight = g(Be, r.paddingRight), this.paddingBottom = g(ue, r.paddingBottom), this.paddingLeft = g(fe, r.paddingLeft), this.position = g(he, r.position), this.textAlign = g(de, r.textAlign), this.textDecorationColor = g(me, r.textDecorationColor || r.color), this.textDecorationLine = g(Ie, r.textDecorationLine), this.textShadow = g(Qe, r.textShadow), this.textTransform = g(pe, r.textTransform), this.transform = g(Ue, r.transform), this.transformOrigin = g(xe, r.transformOrigin), this.visibility = g(He, r.visibility), this.wordBreak = g(ve, r.wordBreak), this.zIndex = g(Me, r.zIndex), this.objectFit = g(Le, r.objectFit);
    }
    return A.prototype.isVisible = function() {
      return this.display > 0 && this.opacity > 0 && this.visibility === Q4.VISIBLE;
    }, A.prototype.isTransparent = function() {
      return VA(this.backgroundColor);
    }, A.prototype.isTransformed = function() {
      return this.transform !== null;
    }, A.prototype.isPositioned = function() {
      return this.position !== SA.STATIC;
    }, A.prototype.isPositionedWithZIndex = function() {
      return this.isPositioned() && !this.zIndex.auto;
    }, A.prototype.isFloating = function() {
      return this.float !== OA.NONE;
  ...
  /* @__PURE__ */ function() {
    function A(r) {
      this.content = g(ye, r.content), this.quotes = g(De, r.quotes);
    }
    return A;
  }()
), N3 = (
  ...
  /* @__PURE__ */ function() {
    function A(r) {
      this.counterIncrement = g(Oe, r.counterIncrement), this.counterReset = g(Se, r.counterReset);
    }
    return A;
  }()
), g = function(A, r) {
  var e = new z5(), n = r !== null && typeof r < "u" ? r.toString() : A.initialValue;
  e.write(n);
  var s = new T2(e.read());
  switch (A.type) {
    case F.IDENT_VALUE:
      var C = s.parseComponentValue();
      return A.parse(O(C) ? C.value : A.initialValue);
    case F.VALUE:
    ...
    case F.TYPE_VALUE:
      switch (A.format) {
        case "angle":
          return O1.parse(s.parseComponentValue());
        case "color":
          return NA.parse(s.parseComponentValue());
        case "image":
          return V2.parse(s.parseComponentValue());
        case "length":
  ...
  /* @__PURE__ */ function() {
    function A(r) {
      this.styles = new Ge(window.getComputedStyle(r, null)), this.textNodes = [], this.elements = [], this.styles.transform !== null && F2(r) && (r.style.transform = "none"), this.bounds = S2(r), this.flags = 0;
    }
    return A;
  }()
), v1 = (
  ...
  return n.forEach(function(o) {
    if (r.textDecorationLine.length || o.trim().length > 0)
      if (cA.SUPPORT_RANGE_BOUNDS)
        s.push(new v1(o, Xe(e, C, o.length)));
      else {
        var a = e.splitText(o.length);
        s.push(new v1(o, Pe(e))), e = a;
      }
    else cA.SUPPORT_RANGE_BOUNDS || (e = e.splitText(o.length));
    C += o.length;
  }), s;
}, Pe = function(A) {
  ...
  if (r) {
    ...
    if (n) {
      n.replaceChild(e, A);
      var s = S2(e);
      return e.firstChild && n.replaceChild(e.firstChild, e), s;
    }
  }
  return new zA(0, 0, 0, 0);
}, Xe = function(A, r, e) {
  var n = A.ownerDocument;
  if (!n)
    throw new Error("Node has no owner document");
  var s = n.createRange();
  return s.setStart(A, r), s.setEnd(A, r + e), zA.fromClientRect(s.getBoundingClientRect());
}, We = function(A, r) {
  return r.letterSpacing !== 0 ? y1(A).map(function(e) {
    return T(e);
  }) : ke(A, r);
}, ke = function(A, r) {
  for (var e = W8(A, {
    lineBreak: r.lineBreak,
    wordBreak: r.overflowWrap === W4.BREAK_WORD ? "break-word" : r.wordBreak
  }), n = [], s; !(s = e.next()).done; )
    s.value && n.push(s.value.slice());
  return n;
}, Je = (
  /** @class */
  /* @__PURE__ */ function() {
    function A(r, e) {
      this.text = qe(r.data, e.textTransform), this.textBounds = ze(this.text, e, r);
    }
    return A;
  }()
), qe = function(A, r) {
  switch (r) {
    ...
    case MA.CAPITALIZE:
      return A.replace(Ye, _e);
    case MA.UPPERCASE:
      return A.toUpperCase();
    default:
      return A;
  }
}, Ye = /(^|\s|:|-|\(|\))([a-z])/g, _e = function(A, r, e) {
  ...
  function(A) {
    ...
    function r(e) {
      ...
      return n.src = e.currentSrc || e.src, n.intrinsicWidth = e.naturalWidth, n.intrinsicHeight = e.naturalHeight, HA.getInstance().addImage(n.src), n;
    }
    return r;
  }(wA)
), l6 = (
  ...
  function(A) {
    IA(r, A);
    function r(e) {
      var n = A.call(this, e) || this, s = new XMLSerializer();
      return n.svg = "data:image/svg+xml," + encodeURIComponent(s.serializeToString(e)), n.intrinsicWidth = e.width.baseVal.value, n.intrinsicHeight = e.height.baseVal.value, HA.getInstance().addImage(n.svg), n;
    }
    return r;
  }(wA)
), c6 = (
  ...
  var r = A.type === t0 ? new Array(A.value.length + 1).join("•") : A.value;
  return r.length === 0 ? A.placeholder || "" : r;
}, M1 = "checkbox", N1 = "radio", t0 = "password", m3 = 707406591, z2 = (
  /** @class */
  function(A) {
    IA(r, A);
    function r(e) {
      var n = A.call(this, e) || this;
      switch (n.type = e.type.toLowerCase(), n.checked = e.checked, n.value = e0(e), (n.type === M1 || n.type === N1) && (n.styles.backgroundColor = 3739148031, n.styles.borderTopColor = n.styles.borderRightColor = n.styles.borderBottomColor = n.styles.borderLeftColor = 2779096575, n.styles.borderTopWidth = n.styles.borderRightWidth = n.styles.borderBottomWidth = n.styles.borderLeftWidth = 1, n.styles.borderTopStyle = n.styles.borderRightStyle = n.styles.borderBottomStyle = n.styles.borderLeftStyle = w4.SOLID, n.styles.backgroundClip = [dA.BORDER_BOX], n.styles.backgroundOrigin = [
        0
        /* BORDER_BOX */
      ], n.bounds = r0(n.bounds)), n.type) {
        case M1:
          n.styles.borderTopRightRadius = n.styles.borderTopLeftRadius = n.styles.borderBottomRightRadius = n.styles.borderBottomLeftRadius = $e;
          break;
        case N1:
          n.styles.borderTopRightRadius = n.styles.borderTopLeftRadius = n.styles.borderBottomRightRadius = n.styles.borderBottomLeftRadius = A0;
          break;
      }
      return n;
    }
  ...
  function(A) {
    IA(r, A);
    function r(e) {
      var n = A.call(this, e) || this, s = e.options[e.selectedIndex || 0];
  ...
  return NA.parse(T2.create(A).parseComponentValue());
}, f6 = (
  /** @class */
  function(A) {
    IA(r, A);
    function r(e) {
      ...
      try {
        if (e.contentWindow && e.contentWindow.document && e.contentWindow.document.documentElement) {
          n.tree = Q6(e.contentWindow.document.documentElement);
          var s = e.contentWindow.document.documentElement ? I3(getComputedStyle(e.contentWindow.document.documentElement).backgroundColor) : xA.TRANSPARENT, C = e.contentWindow.document.body ? I3(getComputedStyle(e.contentWindow.document.body).backgroundColor) : xA.TRANSPARENT;
          n.backgroundColor = VA(s) ? VA(C) ? n.styles.backgroundColor : C : s;
        }
      } catch {
      }
      return n;
...
), n0 = ["OL", "UL", "MENU"], d6 = function(A, r, e) {
  for (var n = A.firstChild, s = void 0; n; n = s)
    if (s = n.nextSibling, p6(n) && n.data.trim().length > 0)
      r.textNodes.push(new Je(n, r.styles));
    else if (V4(n)) {
      var C = h6(n);
      C.styles.isVisible() && (s0(n, C, e) ? C.flags |= 4 : C0(C.styles) && (C.flags |= 2), n0.indexOf(n.tagName) !== -1 && (C.flags |= 8), r.elements.push(C), !m1(n) && !U6(n) && !I1(n) && d6(n, C, e));
    }
}, h6 = function(A) {
  return g6(A) ? new a6(A) : w6(A) ? new l6(A) : U6(A) ? new i6(A) : o0(A) ? new c6(A) : a0(A) ? new E2(A) : l0(A) ? new z2(A) : I1(A) ? new B6(A) : m1(A) ? new u6(A) : E6(A) ? new f6(A) : new wA(A);
}, Q6 = function(A) {
  var r = h6(A);
  return r.flags |= 4, d6(A, r, r), r;
}, s0 = function(A, r, e) {
  return r.styles.isPositionedWithZIndex() || r.styles.opacity < 1 || r.styles.isTransformed() || P2(A) && e.styles.isTransparent();
}, C0 = function(A) {
  ...
  return V4(A) && typeof A.style < "u" && !p1(A);
}, p1 = function(A) {
  ...
  function() {
    ...
    return A.prototype.getCounterValue = function(r) {
      ...
      var e = this, n = r.counterIncrement, s = r.counterReset, C = !0;
      n !== null && n.forEach(function(a) {
        var i = e.counters[a.counter];
        i && a.increment !== 0 && (C = !1, i[Math.max(0, i.length - 1)] += a.increment);
      });
      var o = [];
      return C && s.forEach(function(a) {
        var i = e.counters[a.counter];
        o.push(a.counter), i || (i = e.counters[a.counter] = []), i.push(a.reset);
      }), o;
    }, A;
  }()
), R3 = {
...
}, o4 = function(A, r, e, n, s, C) {
  return A < r || A > e ? k4(A, s, C.length > 0) : n.integers.reduce(function(o, a, i) {
    for (; A >= a; )
      A -= a, o += n.values[i];
    return o;
  }, "") + C;
  ...
  while (A * r >= r);
  return s;
}, D = function(A, r, e, n, s) {
  var C = e - r + 1;
  return (A < 0 ? "-" : "") + (F6(Math.abs(A), C, n, function(o) {
    return T(Math.floor(o % C) + r);
  }) + s);
}, JA = function(A, r, e) {
  e === void 0 && (e = ". ");
  var n = r.length;
  return F6(Math.abs(A), n, !1, function(s) {
    return r[Math.floor(s % n)];
  }) + e;
}, B4 = 1, ZA = 2, jA = 4, D4 = 8, EA = function(A, r, e, n, s, C) {
  if (A < -9999 || A > 9999)
    return k4(A, d.CJK_DECIMAL, s.length > 0);
  var o = Math.abs(A), a = s;
  if (o === 0)
    return r[0] + a;
  for (var i = 0; o > 0 && i <= 4; i++) {
    var l = o % 10;
    l === 0 && W(C, B4) && a !== "" ? a = r[l] + a : l > 1 || l === 1 && i === 0 || l === 1 && i === 1 && W(C, ZA) || l === 1 && i === 1 && W(C, jA) && A > 100 || l === 1 && i > 1 && W(C, D4) ? a = r[l] + (i > 0 ? e[i - 1] : "") + a : l === 1 && i > 0 && (a = e[i - 1] + a), o = Math.floor(o / 10);
  }
  return (A < 0 ? n : "") + a;
}, Z3 = "十百千萬", j3 = "拾佰仟萬", y3 = "マイナス", r2 = "마이너스", k4 = function(A, r, e) {
  var n = e ? ". " : "", s = e ? "、" : "", C = e ? ", " : "", o = e ? " " : "";
  switch (r) {
    case d.DISC:
      return "•" + o;
    ...
    case d.SQUARE:
      return "◾" + o;
    case d.DECIMAL_LEADING_ZERO:
      var a = D(A, 48, 57, !0, n);
      return a.length < 4 ? "0" + a : a;
    case d.CJK_DECIMAL:
      return JA(A, "〇一二三四五六七八九", s);
    case d.LOWER_ROMAN:
      return o4(A, 1, 3999, R3, d.DECIMAL, n).toLowerCase();
    case d.UPPER_ROMAN:
      return o4(A, 1, 3999, R3, d.DECIMAL, n);
    case d.LOWER_GREEK:
      return D(A, 945, 969, !1, n);
    case d.LOWER_ALPHA:
      return D(A, 97, 122, !1, n);
    case d.UPPER_ALPHA:
      return D(A, 65, 90, !1, n);
    case d.ARABIC_INDIC:
      return D(A, 1632, 1641, !0, n);
    case d.ARMENIAN:
    case d.UPPER_ARMENIAN:
      return o4(A, 1, 9999, b3, d.DECIMAL, n);
    case d.LOWER_ARMENIAN:
      return o4(A, 1, 9999, b3, d.DECIMAL, n).toLowerCase();
    case d.BENGALI:
      return D(A, 2534, 2543, !0, n);
    case d.CAMBODIAN:
    case d.KHMER:
      return D(A, 6112, 6121, !0, n);
    case d.CJK_EARTHLY_BRANCH:
      return JA(A, "子丑寅卯辰巳午未申酉戌亥", s);
    case d.CJK_HEAVENLY_STEM:
      return JA(A, "甲乙丙丁戊己庚辛壬癸", s);
    case d.CJK_IDEOGRAPHIC:
    case d.TRAD_CHINESE_INFORMAL:
      return EA(A, "零一二三四五六七八九", Z3, "負", s, ZA | jA | D4);
    case d.TRAD_CHINESE_FORMAL:
      return EA(A, "零壹貳參肆伍陸柒捌玖", j3, "負", s, B4 | ZA | jA | D4);
    case d.SIMP_CHINESE_INFORMAL:
      return EA(A, "零一二三四五六七八九", Z3, "负", s, ZA | jA | D4);
    case d.SIMP_CHINESE_FORMAL:
      return EA(A, "零壹贰叁肆伍陆柒捌玖", j3, "负", s, B4 | ZA | jA | D4);
    case d.JAPANESE_INFORMAL:
      return EA(A, "〇一二三四五六七八九", "十百千万", y3, s, 0);
    case d.JAPANESE_FORMAL:
      return EA(A, "零壱弐参四伍六七八九", "拾百千万", y3, s, B4 | ZA | jA);
    case d.KOREAN_HANGUL_FORMAL:
      return EA(A, "영일이삼사오육칠팔구", "십백천만", r2, C, B4 | ZA | jA);
    case d.KOREAN_HANJA_INFORMAL:
      return EA(A, "零一二三四五六七八九", "十百千萬", r2, C, 0);
    case d.KOREAN_HANJA_FORMAL:
      return EA(A, "零壹貳參四五六七八九", "拾百千", r2, C, B4 | ZA | jA);
    case d.DEVANAGARI:
      return D(A, 2406, 2415, !0, n);
    case d.GEORGIAN:
      return o4(A, 1, 19999, f0, d.DECIMAL, n);
    case d.GUJARATI:
      return D(A, 2790, 2799, !0, n);
    case d.GURMUKHI:
      return D(A, 2662, 2671, !0, n);
    case d.HEBREW:
      return o4(A, 1, 10999, u0, d.DECIMAL, n);
    case d.HIRAGANA:
      return JA(A, "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわゐゑをん");
    case d.HIRAGANA_IROHA:
      return JA(A, "いろはにほへとちりぬるをわかよたれそつねならむうゐのおくやまけふこえてあさきゆめみしゑひもせす");
    case d.KANNADA:
      return D(A, 3302, 3311, !0, n);
    case d.KATAKANA:
      return JA(A, "アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヰヱヲン", s);
    case d.KATAKANA_IROHA:
      return JA(A, "イロハニホヘトチリヌルヲワカヨタレソツネナラムウヰノオクヤマケフコエテアサキユメミシヱヒモセス", s);
    case d.LAO:
      return D(A, 3792, 3801, !0, n);
    case d.MONGOLIAN:
      return D(A, 6160, 6169, !0, n);
    case d.MYANMAR:
      return D(A, 4160, 4169, !0, n);
    case d.ORIYA:
      return D(A, 2918, 2927, !0, n);
    case d.PERSIAN:
      return D(A, 1776, 1785, !0, n);
    case d.TAMIL:
      return D(A, 3046, 3055, !0, n);
    case d.TELUGU:
      return D(A, 3174, 3183, !0, n);
    case d.THAI:
      return D(A, 3664, 3673, !0, n);
    case d.TIBETAN:
      return D(A, 3872, 3881, !0, n);
    case d.DECIMAL:
    default:
      return D(A, 48, 57, !0, n);
  }
}, x6 = "data-html2canvas-ignore", O3 = (
  /** @class */
  function() {
    function A(r, e) {
      if (this.options = e, this.scrolledElements = [], this.referenceElement = r, this.counters = new B0(), this.quoteDepth = 0, !r.ownerDocument)
    ...
    return A.prototype.toIFrame = function(r, e) {
      ...
      var C = r.defaultView.pageXOffset, o = r.defaultView.pageYOffset, a = s.contentWindow, i = a.document, l = h0(s).then(function() {
        return aA(n, void 0, void 0, function() {
          var c;
          return CA(this, function(B) {
            switch (B.label) {
              case 0:
                return this.scrolledElements.forEach(U0), a && (a.scrollTo(e.left, e.top), /(iPad|iPhone|iPod)/g.test(navigator.userAgent) && (a.scrollY !== e.top || a.scrollX !== e.left) && (i.documentElement.style.top = -e.top + "px", i.documentElement.style.left = -e.left + "px", i.documentElement.style.position = "absolute")), c = this.options.onclone, typeof this.clonedReferenceElement > "u" ? [2, Promise.reject("Error finding the " + this.referenceElement.nodeName + " in the cloned document")] : i.fonts && i.fonts.ready ? [4, i.fonts.ready] : [3, 2];
              case 1:
                B.sent(), B.label = 2;
              case 2:
      ...
      return i.open(), i.write(Q0(document.doctype) + "<html></html>"), p0(this.referenceElement.ownerDocument, C, o), i.replaceChild(i.adoptNode(this.documentElement), i.documentElement), i.close(), l;
      ...
      var e = r.cloneNode(!1);
      return g6(e) && e.loading === "lazy" && (e.loading = "eager"), e;
    }, A.prototype.createStyleClone = function(r) {
      try {
        var e = r.sheet;
        if (e && e.cssRules) {
          var n = [].slice.call(e.cssRules, 0).reduce(function(C, o) {
            return o && typeof o.cssText == "string" ? C + o.cssText : C;
          }, ""), s = r.cloneNode(!1);
          return s.textContent = n, s;
        }
      } catch (C) {
        if (z.getInstance(this.options.id).error("Unable to access cssRules property", C), C.name !== "SecurityError")
          throw C;
      }
      ...
      if (this.options.inlineImages && r.ownerDocument) {
        ...
        try {
          ...
          z.getInstance(this.options.id).info("Unable to clone canvas contents, canvas is tainted");
        }
      }
      var n = r.cloneNode(!1);
      try {
        n.width = r.width, n.height = r.height;
        var s = r.getContext("2d"), C = n.getContext("2d");
        return C && (s ? C.putImageData(s.getImageData(0, 0, r.width, r.height), 0, 0) : C.drawImage(r, 0, 0)), n;
      } catch {
      }
      return n;
      ...
      if (e && V4(r) && (F2(r) || p1(r))) {
        var n = this.createElementClone(r), s = e.getComputedStyle(r), C = e.getComputedStyle(r, ":before"), o = e.getComputedStyle(r, ":after");
        this.referenceElement === r && F2(n) && (this.clonedReferenceElement = n), P2(n) && E0(n);
        for (var a = this.counters.parse(new N3(s)), i = this.resolvePseudoContent(r, n, C, z4.BEFORE), l = r.firstChild; l; l = l.nextSibling)
          (!V4(l) || !c0(l) && !l.hasAttribute(x6) && (typeof this.options.ignoreElements != "function" || !this.options.ignoreElements(l))) && (!this.options.copyStyles || !V4(l) || !K3(l)) && n.appendChild(this.cloneNode(l));
        i && n.insertBefore(i, n.firstChild);
        var c = this.resolvePseudoContent(r, n, o, z4.AFTER);
        return c && n.appendChild(c), this.counters.pop(a), s && (this.options.copyStyles || p1(r)) && !E6(r) && S3(s, n), (r.scrollTop !== 0 || r.scrollLeft !== 0) && this.scrolledElements.push([n, r.scrollLeft, r.scrollTop]), (m1(r) || I1(r)) && (m1(n) || I1(n)) && (n.value = r.value), n;
      }
      return r.cloneNode(!1);
    }, A.prototype.resolvePseudoContent = function(r, e, n, s) {
      var C = this;
      if (n) {
        var o = n.content, a = e.ownerDocument;
        if (!(!a || !o || o === "none" || o === "-moz-alt-content" || n.display === "none")) {
          this.counters.parse(new N3(n));
          var i = new Ve(n), l = a.createElement("html2canvaspseudoelement");
          S3(n, l), i.content.forEach(function(B) {
            if (B.type === f.STRING_TOKEN)
              l.appendChild(a.createTextNode(B.value));
            else if (B.type === f.URL_TOKEN) {
              var u = a.createElement("img");
              u.src = B.value, u.style.opacity = "1", l.appendChild(u);
            } else if (B.type === f.FUNCTION) {
              if (B.name === "attr") {
                var h = B.values.filter(O);
                h.length && l.appendChild(a.createTextNode(r.getAttribute(h[0].value) || ""));
              } else if (B.name === "counter") {
                var U = B.values.filter(U4), w = U[0], p = U[1];
                if (w && O(w)) {
                  var Q = C.counters.getCounterValue(w.value), v = p && O(p) ? g2.parse(p.value) : d.DECIMAL;
                  l.appendChild(a.createTextNode(k4(Q, v, !1)));
                }
              } else if (B.name === "counters") {
                var I = B.values.filter(U4), w = I[0], M = I[1], p = I[2];
                if (w && O(w)) {
                  var Z = C.counters.getCounterValues(w.value), N = p && O(p) ? g2.parse(p.value) : d.DECIMAL, x = M && M.type === f.STRING_TOKEN ? M.value : "", K = Z.map(function(m) {
                    return k4(m, N, !1);
                  }).join(x);
                  l.appendChild(a.createTextNode(K));
                }
              }
            } else if (B.type === f.IDENT_TOKEN)
              switch (B.value) {
                case "open-quote":
                  l.appendChild(a.createTextNode(M3(i.quotes, C.quoteDepth++, !0)));
                  break;
                case "close-quote":
                  l.appendChild(a.createTextNode(M3(i.quotes, --C.quoteDepth, !1)));
                  break;
                default:
                  l.appendChild(a.createTextNode(B.value));
              }
          }), l.className = x2 + " " + H2;
          var c = s === z4.BEFORE ? " " + x2 : " " + H2;
          return p1(e) ? e.className.baseValue += c : e.className += c, l;
        }
      }
    }, A.destroy = function(r) {
...
var d0 = function(A, r) {
  ...
  return e.className = "html2canvas-container", e.style.visibility = "hidden", e.style.position = "fixed", e.style.left = "-10000px", e.style.top = "0px", e.style.border = "0", e.width = r.width.toString(), e.height = r.height.toString(), e.scrolling = "no", e.setAttribute(x6, "true"), A.body.appendChild(e), e;
}, h0 = function(A) {
  return new Promise(function(r, e) {
    ...
    var s = n.document;
    n.onload = A.onload = s.onreadystatechange = function() {
      n.onload = A.onload = s.onreadystatechange = null;
      var C = setInterval(function() {
        s.body.childNodes.length > 0 && s.readyState === "complete" && (clearInterval(C), r(A));
      }, 50);
    };
  });
}, S3 = function(A, r) {
...
}, w0 = ":before", g0 = ":after", x2 = "___html2canvas___pseudoelement_before", H2 = "___html2canvas___pseudoelement_after", D3 = `{
    content: "" !important;
...
var T3 = function(A, r) {
...
}, x0 = function(A, r, e, n, s) {
  return A.map(function(C, o) {
    switch (o) {
      case 0:
        return C.add(r, e);
      case 1:
  ...
  function() {
    function A(r, e) {
      this.type = J4.VECTOR, this.x = r, this.y = e;
    }
  ...
  function() {
    function A(r, e, n, s) {
      this.type = J4.BEZIER_CURVE, this.start = r, this.startControl = e, this.endControl = n, this.end = s;
    }
    return A.prototype.subdivide = function(r, e) {
      var n = a4(this.start, this.startControl, r), s = a4(this.startControl, this.endControl, r), C = a4(this.endControl, this.end, r), o = a4(n, s, r), a = a4(s, C, r), i = a4(o, a, r);
      return e ? new A(this.start, n, o, i) : new A(i, a, C, this.end);
  ...
  return A.type === J4.BEZIER_CURVE;
}, H0 = (
  /** @class */
  /* @__PURE__ */ function() {
    function A(r) {
      var e = r.styles, n = r.bounds, s = S4(e.borderTopLeftRadius, n.width, n.height), C = s[0], o = s[1], a = S4(e.borderTopRightRadius, n.width, n.height), i = a[0], l = a[1], c = S4(e.borderBottomRightRadius, n.width, n.height), B = c[0], u = c[1], h = S4(e.borderBottomLeftRadius, n.width, n.height), U = h[0], w = h[1], p = [];
      p.push((C + i) / n.width), p.push((U + B) / n.width), p.push((o + w) / n.height), p.push((l + u) / n.height);
      var Q = Math.max.apply(Math, p);
      Q > 1 && (C /= Q, o /= Q, i /= Q, l /= Q, B /= Q, u /= Q, U /= Q, w /= Q);
      var v = n.width - i, I = n.height - u, M = n.width - B, Z = n.height - w, N = e.borderTopWidth, x = e.borderRightWidth, K = e.borderBottomWidth, H = e.borderLeftWidth, j = S(e.paddingTop, r.bounds.width), m = S(e.paddingRight, r.bounds.width), y = S(e.paddingBottom, r.bounds.width), b = S(e.paddingLeft, r.bounds.width);
      this.topLeftBorderBox = C > 0 || o > 0 ? iA(n.left, n.top, C, o, V.TOP_LEFT) : new E(n.left, n.top), this.topRightBorderBox = i > 0 || l > 0 ? iA(n.left + v, n.top, i, l, V.TOP_RIGHT) : new E(n.left + n.width, n.top), this.bottomRightBorderBox = B > 0 || u > 0 ? iA(n.left + M, n.top + I, B, u, V.BOTTOM_RIGHT) : new E(n.left + n.width, n.top + n.height), this.bottomLeftBorderBox = U > 0 || w > 0 ? iA(n.left, n.top + Z, U, w, V.BOTTOM_LEFT) : new E(n.left, n.top + n.height), this.topLeftPaddingBox = C > 0 || o > 0 ? iA(n.left + H, n.top + N, Math.max(0, C - H), Math.max(0, o - N), V.TOP_LEFT) : new E(n.left + H, n.top + N), this.topRightPaddingBox = i > 0 || l > 0 ? iA(n.left + Math.min(v, n.width + H), n.top + N, v > n.width + H ? 0 : i - H, l - N, V.TOP_RIGHT) : new E(n.left + n.width - x, n.top + N), this.bottomRightPaddingBox = B > 0 || u > 0 ? iA(n.left + Math.min(M, n.width - H), n.top + Math.min(I, n.height + N), Math.max(0, B - x), u - K, V.BOTTOM_RIGHT) : new E(n.left + n.width - x, n.top + n.height - K), this.bottomLeftPaddingBox = U > 0 || w > 0 ? iA(n.left + H, n.top + Z, Math.max(0, U - H), w - K, V.BOTTOM_LEFT) : new E(n.left + H, n.top + n.height - K), this.topLeftContentBox = C > 0 || o > 0 ? iA(n.left + H + b, n.top + N + j, Math.max(0, C - (H + b)), Math.max(0, o - (N + j)), V.TOP_LEFT) : new E(n.left + H + b, n.top + N + j), this.topRightContentBox = i > 0 || l > 0 ? iA(n.left + Math.min(v, n.width + H + b), n.top + N + j, v > n.width + H + b ? 0 : i - H + b, l - (N + j), V.TOP_RIGHT) : new E(n.left + n.width - (x + m), n.top + N + j), this.bottomRightContentBox = B > 0 || u > 0 ? iA(n.left + Math.min(M, n.width - (H + b)), n.top + Math.min(I, n.height + N + j), Math.max(0, B - (x + m)), u - (K + y), V.BOTTOM_RIGHT) : new E(n.left + n.width - (x + m), n.top + n.height - (K + y)), this.bottomLeftContentBox = U > 0 || w > 0 ? iA(n.left + H + b, n.top + Z, Math.max(0, U - (H + b)), w - (K + y), V.BOTTOM_LEFT) : new E(n.left + H + b, n.top + n.height - (K + y));
    }
    return A;
  }()
), V;
...
var iA = function(A, r, e, n, s) {
  var C = 4 * ((Math.sqrt(2) - 1) / 3), o = e * C, a = n * C, i = A + e, l = r + n;
  switch (s) {
    case V.TOP_LEFT:
      return new B1(new E(A, l), new E(A, l - a), new E(i - o, r), new E(i, r));
    case V.TOP_RIGHT:
      return new B1(new E(A, r), new E(A + o, r), new E(i, l - a), new E(i, l));
    case V.BOTTOM_RIGHT:
      return new B1(new E(i, r), new E(i, r + a), new E(A + o, l), new E(A, l));
    case V.BOTTOM_LEFT:
    default:
      return new B1(new E(i, l), new E(i - o, l), new E(A, r + a), new E(A, r));
  }
}, K1 = function(A) {
  ...
  function() {
    function A(r, e) {
      if (this.container = r, this.effects = e.slice(0), this.curves = new H0(r), r.styles.transform !== null) {
        var n = r.bounds.left + r.styles.transformOrigin[0].number, s = r.bounds.top + r.styles.transformOrigin[1].number, C = r.styles.transform;
        this.effects.push(new M0(n, s, C));
      }
      if (r.styles.overflowX !== GA.VISIBLE) {
        var o = K1(this.curves), a = A4(this.curves);
        T3(o, a) ? this.effects.push(new u1(
          o,
          6
          /* CONTENT */
        )) : (this.effects.push(new u1(
          o,
          2
          /* BACKGROUND_BORDERS */
        )), this.effects.push(new u1(
    ...
    return A.prototype.getParentEffects = function() {
      ...
      if (this.container.styles.overflowX !== GA.VISIBLE) {
        var e = K1(this.curves), n = A4(this.curves);
        T3(e, n) || r.push(new u1(
          n,
          6
          /* CONTENT */
        ));
  ...
  A.container.elements.forEach(function(s) {
    ...
    if (C || o) {
      var l = C || s.styles.isPositioned() ? e : r, c = new H6(a);
      if (s.styles.isPositioned() || s.styles.opacity < 1 || s.styles.isTransformed()) {
        var B = s.styles.zIndex.order;
        if (B < 0) {
          var u = 0;
          l.negativeZIndex.some(function(U, w) {
            return B > U.element.container.styles.zIndex.order ? (u = w, !1) : u > 0;
          }), l.negativeZIndex.splice(u, 0, c);
        } else if (B > 0) {
          var h = 0;
          l.positiveZIndex.some(function(U, w) {
      ...
      s.styles.isInlineLevel() ? r.inlineLevel.push(a) : r.nonInlineLevel.push(a), v2(a, r, e, i);
    W(
      s.flags,
      8
      /* IS_LIST_OWNER */
  ...
  for (var e = A instanceof E2 ? A.start : 1, n = A instanceof E2 ? A.reversed : !1, s = 0; s < r.length; s++) {
    var C = r[s];
    C.container instanceof c6 && typeof C.container.value == "number" && C.container.value !== 0 && (e = C.container.value), C.listValue = k4(e, C.container.styles.listStyleType, !0), e += n ? -1 : 1;
  }
}, I0 = function(A) {
  var r = new v6(A, []), e = new H6(r), n = [];
  return v2(r, e, e, n), M6(r.container, n), e;
}, K0 = function(A, r) {
  switch (r) {
    case 0:
      return f1(A.topLeftBorderBox, A.topLeftPaddingBox, A.topRightBorderBox, A.topRightPaddingBox);
    case 1:
      return f1(A.topRightBorderBox, A.topRightPaddingBox, A.bottomRightBorderBox, A.bottomRightPaddingBox);
    case 2:
      return f1(A.bottomRightBorderBox, A.bottomRightPaddingBox, A.bottomLeftBorderBox, A.bottomLeftPaddingBox);
    case 3:
    default:
      return f1(A.bottomLeftBorderBox, A.bottomLeftPaddingBox, A.topLeftBorderBox, A.topLeftPaddingBox);
  }
}, f1 = function(A, r, e, n) {
  var s = [];
  return f4(A) ? s.push(A.subdivide(0.5, !1)) : s.push(A), f4(e) ? s.push(e.subdivide(0.5, !0)) : s.push(e), f4(n) ? s.push(n.subdivide(0.5, !0).reverse()) : s.push(n), f4(r) ? s.push(r.subdivide(0.5, !1).reverse()) : s.push(r), s;
}, N6 = function(A) {
  ...
  var r = A.styles, e = A.bounds, n = S(r.paddingLeft, e.width), s = S(r.paddingRight, e.width), C = S(r.paddingTop, e.width), o = S(r.paddingBottom, e.width);
  return e.add(n + r.borderLeftWidth, C + r.borderTopWidth, -(r.borderRightWidth + r.borderLeftWidth + n + s), -(r.borderTopWidth + r.borderBottomWidth + C + o));
}, R0 = function(A, r) {
  return A === 0 ? r.bounds : A === 2 ? YA(r) : N6(r);
}, b0 = function(A, r) {
  return A === dA.BORDER_BOX ? r.bounds : A === dA.CONTENT_BOX ? YA(r) : N6(r);
}, e2 = function(A, r, e) {
  var n = R0(u4(A.styles.backgroundOrigin, r), A), s = b0(u4(A.styles.backgroundClip, r), A), C = Z0(u4(A.styles.backgroundSize, r), e, n), o = C[0], a = C[1], i = S4(u4(A.styles.backgroundPosition, r), n.width - o, n.height - a), l = j0(u4(A.styles.backgroundRepeat, r), i, C, n, s), c = Math.round(n.left + i[0]), B = Math.round(n.top + i[1]);
  return [l, c, B, o, a];
}, l4 = function(A) {
  return O(A) && A.value === h4.AUTO;
}, d1 = function(A) {
  return typeof A == "number";
}, Z0 = function(A, r, e) {
  var n = r[0], s = r[1], C = r[2], o = A[0], a = A[1];
  if (L(o) && a && L(a))
    return [S(o, e.width), S(a, e.height)];
  var i = d1(C);
  if (O(o) && (o.value === h4.CONTAIN || o.value === h4.COVER)) {
    if (d1(C)) {
      var l = e.width / e.height;
      return l < C != (o.value === h4.COVER) ? [e.width, e.width / C] : [e.height * C, e.height];
    }
    return [e.width, e.height];
  }
  var c = d1(n), B = d1(s), u = c || B;
  if (l4(o) && (!a || l4(a))) {
    if (c && B)
      return [n, s];
    if (!i && !u)
      return [e.width, e.height];
    if (u && i) {
      var h = c ? n : s * C, U = B ? s : n / C;
      return [h, U];
    }
    var w = c ? n : e.width, p = B ? s : e.height;
    return [w, p];
  }
  if (i) {
    var Q = 0, v = 0;
    return L(o) ? Q = S(o, e.width) : L(a) && (v = S(a, e.height)), l4(o) ? Q = v * C : (!a || l4(a)) && (v = Q / C), [Q, v];
  }
  var I = null, M = null;
  if (L(o) ? I = S(o, e.width) : a && L(a) && (M = S(a, e.height)), I !== null && (!a || l4(a)) && (M = c && B ? I / n * s : e.height), M !== null && l4(o) && (I = c && B ? M / s * n : e.width), I !== null && M !== null)
    return [I, M];
  throw new Error("Unable to calculate background-size for element");
}, u4 = function(A, r) {
  var e = A[r];
  return typeof e > "u" ? A[0] : e;
}, j0 = function(A, r, e, n, s) {
  var C = r[0], o = r[1], a = e[0], i = e[1];
  switch (A) {
    case vA.REPEAT_X:
      return [
        new E(Math.round(n.left), Math.round(n.top + o)),
        new E(Math.round(n.left + n.width), Math.round(n.top + o)),
        new E(Math.round(n.left + n.width), Math.round(i + n.top + o)),
        new E(Math.round(n.left), Math.round(i + n.top + o))
      ];
    case vA.REPEAT_Y:
      return [
        new E(Math.round(n.left + C), Math.round(n.top)),
        new E(Math.round(n.left + C + a), Math.round(n.top)),
        new E(Math.round(n.left + C + a), Math.round(n.height + n.top)),
        new E(Math.round(n.left + C), Math.round(n.height + n.top))
      ];
    case vA.NO_REPEAT:
      return [
        new E(Math.round(n.left + C), Math.round(n.top + o)),
        new E(Math.round(n.left + C + a), Math.round(n.top + o)),
        new E(Math.round(n.left + C + a), Math.round(n.top + o + i)),
        new E(Math.round(n.left + C), Math.round(n.top + o + i))
      ];
    default:
      return [
...
}, y0 = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", L3 = "Hidden Text", O0 = (
  /** @class */
  function() {
    function A(r) {
    ...
    return A.prototype.parseMetrics = function(r, e) {
      var n = this._document.createElement("div"), s = this._document.createElement("img"), C = this._document.createElement("span"), o = this._document.body;
      n.style.visibility = "hidden", n.style.fontFamily = r, n.style.fontSize = e, n.style.margin = "0", n.style.padding = "0", o.appendChild(n), s.src = y0, s.width = 1, s.height = 1, s.style.margin = "0", s.style.padding = "0", s.style.verticalAlign = "baseline", C.style.fontFamily = r, C.style.fontSize = e, C.style.margin = "0", C.style.padding = "0", C.appendChild(this._document.createTextNode(L3)), n.appendChild(C), n.appendChild(s);
      var a = s.offsetTop - C.offsetTop + 2;
      n.removeChild(C), n.appendChild(this._document.createTextNode(L3)), n.style.lineHeight = "normal", s.style.verticalAlign = "super";
      var i = s.offsetTop - n.offsetTop + 2;
      return o.removeChild(n), { baseline: a, middle: i };
  ...
  function() {
    function A(r) {
      this._activeEffects = [], this.canvas = r.canvas ? r.canvas : document.createElement("canvas"), this.ctx = this.canvas.getContext("2d"), this.options = r, r.canvas || (this.canvas.width = Math.floor(r.width * r.scale), this.canvas.height = Math.floor(r.height * r.scale), this.canvas.style.width = r.width + "px", this.canvas.style.height = r.height + "px"), this.fontMetrics = new O0(document), this.ctx.scale(this.options.scale, this.options.scale), this.ctx.translate(-r.x + r.scrollX, -r.y + r.scrollY), this.ctx.textBaseline = "bottom", this._activeEffects = [], z.getInstance(r.id).debug("Canvas renderer initialized (" + r.width + "x" + r.height + " at " + r.x + "," + r.y + ") with scale " + r.scale);
    }
    return A.prototype.applyEffects = function(r, e) {
      ...
      this.ctx.save(), N0(r) && (this.ctx.translate(r.offsetX, r.offsetY), this.ctx.transform(r.matrix[0], r.matrix[1], r.matrix[2], r.matrix[3], r.matrix[4], r.matrix[5]), this.ctx.translate(-r.offsetX, -r.offsetY)), m0(r) && (this.path(r.path), this.ctx.clip()), this._activeEffects.push(r);
      ...
      if (e === 0)
        ...
        var s = y1(r.text).map(function(C) {
          return T(C);
        });
        s.reduce(function(C, o) {
          return n.ctx.fillText(o, C, r.bounds.top + r.bounds.height), C + n.ctx.measureText(o).width;
        }, r.bounds.left);
      }
    }, A.prototype.createFontStyle = function(r) {
      var e = r.fontVariant.filter(function(C) {
        return C === "normal" || C === "small-caps";
      }).join(""), n = r.fontFamily.join(", "), s = L2(r.fontSize) ? "" + r.fontSize.number + r.fontSize.unit : r.fontSize.number + "px";
      return [
        [r.fontStyle, e, r.fontWeight, s, n].join(" "),
        n,
        s
      ];
      ...
      return aA(this, void 0, void 0, function() {
        var n, s, C, o, a = this;
        return CA(this, function(i) {
          return n = this.createFontStyle(e), s = n[0], C = n[1], o = n[2], this.ctx.font = s, r.textBounds.forEach(function(l) {
            a.ctx.fillStyle = AA(e.color), a.renderTextWithLetterSpacing(l, e.letterSpacing);
            var c = e.textShadow;
            c.length && l.text.trim().length && (c.slice(0).reverse().forEach(function(B) {
              a.ctx.shadowColor = AA(B.color), a.ctx.shadowOffsetX = B.offsetX.number * a.options.scale, a.ctx.shadowOffsetY = B.offsetY.number * a.options.scale, a.ctx.shadowBlur = B.blur.number, a.ctx.fillText(l.text, l.bounds.left, l.bounds.top + l.bounds.height);
            }), a.ctx.shadowColor = "", a.ctx.shadowOffsetX = 0, a.ctx.shadowOffsetY = 0, a.ctx.shadowBlur = 0), e.textDecorationLine.length && (a.ctx.fillStyle = AA(e.textDecorationColor || e.color), e.textDecorationLine.forEach(function(B) {
              switch (B) {
                case 1:
                  var u = a.fontMetrics.getMetrics(C, o).baseline;
                  a.ctx.fillRect(l.bounds.left, Math.round(l.bounds.top + u), l.bounds.width, 1);
                  break;
                case 2:
                  a.ctx.fillRect(l.bounds.left, Math.round(l.bounds.top), l.bounds.width, 1);
                  break;
                case 3:
                  var h = a.fontMetrics.getMetrics(C, o).middle;
                  a.ctx.fillRect(l.bounds.left, Math.ceil(l.bounds.top + h), l.bounds.width, 1);
                  break;
              }
            }));
          }), [
      ...
      if (n && r.intrinsicWidth > 0 && r.intrinsicHeight > 0)
        if (r.styles.objectFit == "cover") {
          var s = YA(r), C = 30, o = 30, a = s.left, i = s.top;
          r.intrinsicWidth / s.width < r.intrinsicHeight / s.height ? (C = s.width, o = r.intrinsicHeight * (s.width / r.intrinsicWidth), i = s.top + (s.height - o) / 2) : (C = r.intrinsicWidth * (s.height / r.intrinsicHeight), o = s.height, a = s.left + (s.width - C) / 2);
          var l = A4(e);
          this.path(l), this.ctx.save(), this.ctx.clip(), this.ctx.drawImage(n, 0, 0, r.intrinsicWidth, r.intrinsicHeight, a, i, C, o), this.ctx.restore();
        } else if (r.styles.objectFit == "contain") {
          var s = YA(r), C = 0, o = 0, a = s.left, i = s.top;
          r.intrinsicWidth / s.width < r.intrinsicHeight / s.height ? (C = r.intrinsicWidth * (s.height / r.intrinsicHeight), o = s.height, a = s.left + (s.width - C) / 2) : (C = s.width, o = r.intrinsicHeight * (s.width / r.intrinsicWidth), i = s.top + (s.height - o) / 2);
          var l = A4(e);
          this.path(l), this.ctx.save(), this.ctx.clip(), this.ctx.drawImage(n, 0, 0, r.intrinsicWidth, r.intrinsicHeight, a, i, C, o), this.ctx.restore();
        } else if (r.styles.objectFit == "fill") {
          var s = YA(r), l = A4(e);
          this.path(l), this.ctx.save(), this.ctx.clip(), this.ctx.drawImage(n, 0, 0, r.intrinsicWidth, r.intrinsicHeight, s.left, s.top, s.width, s.height), this.ctx.restore();
        } else {
          var s = YA(r), l = A4(e);
          this.path(l), this.ctx.save(), this.ctx.clip(), this.ctx.drawImage(n, 0, 0, r.intrinsicWidth, r.intrinsicHeight, s.left, s.top, s.width, s.height), this.ctx.restore();
        }
      ...
      return aA(this, void 0, void 0, function() {
        var e, n, s, C, o, a, U, U, i, l, c, p, B, u, h, U, w, p;
        return CA(this, function(Q) {
          switch (Q.label) {
            case 0:
              this.applyEffects(
                r.effects,
                4
                /* CONTENT */
              ), e = r.container, n = r.curves, s = e.styles, C = 0, o = e.textNodes, Q.label = 1;
            case 1:
              return C < o.length ? (a = o[C], [4, this.renderTextNode(a, s)]) : [3, 4];
            case 2:
              Q.sent(), Q.label = 3;
            case 3:
              return C++, [3, 1];
            case 4:
              if (!(e instanceof a6)) return [3, 8];
              Q.label = 5;
            case 5:
              return Q.trys.push([5, 7, , 8]), [4, this.options.cache.match(e.src)];
            case 6:
              return U = Q.sent(), this.renderReplacedElement(e, n, U), [3, 8];
            case 7:
              return Q.sent(), z.getInstance(this.options.id).error("Error loading image " + e.src), [3, 8];
            case 8:
              if (e instanceof l6 && this.renderReplacedElement(e, n, e.canvas), !(e instanceof i6)) return [3, 12];
              Q.label = 9;
            case 9:
              return Q.trys.push([9, 11, , 12]), [4, this.options.cache.match(e.svg)];
            case 10:
              return U = Q.sent(), this.renderReplacedElement(e, n, U), [3, 12];
            case 11:
              return Q.sent(), z.getInstance(this.options.id).error("Error loading svg " + e.svg.substring(0, 255)), [3, 12];
            case 12:
              return e instanceof f6 && e.tree ? (i = new A({
                id: this.options.id,
              ...
              }), [4, i.render(e.tree)]) : [3, 14];
            case 13:
              l = Q.sent(), e.width && e.height && this.ctx.drawImage(l, 0, 0, e.width, e.height, e.bounds.left, e.bounds.top, e.bounds.width, e.bounds.height), Q.label = 14;
            case 14:
              if (e instanceof z2 && (c = Math.min(e.bounds.width, e.bounds.height), e.type === M1 ? e.checked && (this.ctx.save(), this.path([
                ...
                new E(e.bounds.left + c * 0.39363, e.bounds.top + c * 0.79)
              ]), this.ctx.fillStyle = AA(m3), this.ctx.fill(), this.ctx.restore()) : e.type === N1 && e.checked && (this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(e.bounds.left + c / 2, e.bounds.top + c / 2, c / 4, 0, Math.PI * 2, !0), this.ctx.fillStyle = AA(m3), this.ctx.fill(), this.ctx.restore())), T0(e) && e.value.length) {
                switch (this.ctx.font = this.createFontStyle(s)[0], this.ctx.fillStyle = AA(s.color), this.ctx.textBaseline = "middle", this.ctx.textAlign = G0(e.styles.textAlign), p = YA(e), B = 0, e.styles.textAlign) {
                  case pA.CENTER:
                    B += p.width / 2;
                    break;
                  case pA.RIGHT:
                ...
                u = p.add(B, 0, 0, -p.height / 2 + 1), this.ctx.save(), this.path([
                  new E(p.left, p.top),
                  new E(p.left + p.width, p.top),
                  new E(p.left + p.width, p.top + p.height),
                  new E(p.left, p.top + p.height)
                ]), this.ctx.clip(), this.renderTextWithLetterSpacing(new v1(e.value, u), s.letterSpacing), this.ctx.restore(), this.ctx.textBaseline = "bottom", this.ctx.textAlign = "left";
              }
              if (!W(
                e.styles.display,
                2048
              ...
              if (h = e.styles.listStyleImage, h.type !== tA.URL) return [3, 18];
              U = void 0, w = h.url, Q.label = 15;
            case 15:
              return Q.trys.push([15, 17, , 18]), [4, this.options.cache.match(w)];
            case 16:
              return U = Q.sent(), this.ctx.drawImage(U, e.bounds.left - (U.width + 10), e.bounds.top), [3, 18];
            case 17:
              return Q.sent(), z.getInstance(this.options.id).error("Error loading list-style-image " + w), [3, 18];
            case 18:
              return [3, 20];
            case 19:
              r.listValue && e.styles.listStyleType !== d.NONE && (this.ctx.font = this.createFontStyle(s)[0], this.ctx.fillStyle = AA(s.color), this.ctx.textBaseline = "middle", this.ctx.textAlign = "right", p = new zA(e.bounds.left, e.bounds.top + S(e.styles.paddingTop, e.bounds.width), e.bounds.width, ee(s.lineHeight, s.fontSize.number) / 2 + 1), this.renderTextWithLetterSpacing(new v1(r.listValue, p), s.letterSpacing), this.ctx.textBaseline = "bottom", this.ctx.textAlign = "left"), Q.label = 20;
            case 20:
              return [
                2
                /*return*/
      ...
      return aA(this, void 0, void 0, function() {
        var e, n, p, s, C, p, o, a, p, i, l, p, c, B, p, u, h, p, U, w, p;
        return CA(this, function(Q) {
          switch (Q.label) {
            case 0:
              return [4, this.renderNodeBackgroundAndBorders(r.element)];
            case 1:
              Q.sent(), e = 0, n = r.negativeZIndex, Q.label = 2;
            case 2:
              return e < n.length ? (p = n[e], [4, this.renderStack(p)]) : [3, 5];
            case 3:
              Q.sent(), Q.label = 4;
            case 4:
              return e++, [3, 2];
            ...
            case 6:
              Q.sent(), s = 0, C = r.nonInlineLevel, Q.label = 7;
            case 7:
            ...
            case 9:
              return s++, [3, 7];
            case 10:
              o = 0, a = r.nonPositionedFloats, Q.label = 11;
            case 11:
            ...
            case 13:
              return o++, [3, 11];
            case 14:
              i = 0, l = r.nonPositionedInlineLevel, Q.label = 15;
            case 15:
              return i < l.length ? (p = l[i], [4, this.renderStack(p)]) : [3, 18];
            case 16:
              Q.sent(), Q.label = 17;
            case 17:
              return i++, [3, 15];
            case 18:
              c = 0, B = r.inlineLevel, Q.label = 19;
            case 19:
              return c < B.length ? (p = B[c], [4, this.renderNode(p)]) : [3, 22];
            case 20:
              Q.sent(), Q.label = 21;
            case 21:
              return c++, [3, 19];
            case 22:
              u = 0, h = r.zeroOrAutoZIndexOrTransformedOrOpacity, Q.label = 23;
            case 23:
              return u < h.length ? (p = h[u], [4, this.renderStack(p)]) : [3, 26];
            case 24:
              Q.sent(), Q.label = 25;
            case 25:
              return u++, [3, 23];
            case 26:
              U = 0, w = r.positiveZIndex, Q.label = 27;
            case 27:
              return U < w.length ? (p = w[U], [4, this.renderStack(p)]) : [3, 30];
            case 28:
              Q.sent(), Q.label = 29;
            case 29:
              return U++, [3, 27];
      ...
      r.forEach(function(n, s) {
        var C = f4(n) ? n.start : n;
        s === 0 ? e.ctx.moveTo(C.x, C.y) : e.ctx.lineTo(C.x, C.y), f4(n) && e.ctx.bezierCurveTo(n.startControl.x, n.startControl.y, n.endControl.x, n.endControl.y, n.end.x, n.end.y);
      });
    }, A.prototype.renderRepeat = function(r, e, n, s) {
      this.path(r), this.ctx.fillStyle = e, this.ctx.translate(n, s), this.ctx.fill(), this.ctx.translate(-n, -s);
    }, A.prototype.resizeImage = function(r, e, n) {
      if (r.width === e && r.height === n)
        return r;
      var s = this.canvas.ownerDocument.createElement("canvas");
      s.width = e, s.height = n;
      var C = s.getContext("2d");
      return C.drawImage(r, 0, 0, r.width, r.height, 0, 0, e, n), s;
      ...
      return aA(this, void 0, void 0, function() {
        ...
        return CA(this, function(i) {
          switch (i.label) {
            case 0:
              e = r.styles.backgroundImage.length - 1, n = function(l) {
                var c, B, u, H, q, $, y, b, x, h, H, q, $, y, b, U, w, p, Q, v, I, M, Z, N, x, K, H, j, m, y, b, gA, q, $, KA, nA, t4, E4, RA, WA, F4, x4;
                return CA(this, function(bA) {
                  switch (bA.label) {
                    case 0:
                      if (l.type !== tA.URL) return [3, 5];
                      c = void 0, B = l.url, bA.label = 1;
                    case 1:
                      return bA.trys.push([1, 3, , 4]), [4, s.options.cache.match(B)];
                    case 2:
                      return c = bA.sent(), [3, 4];
                    case 3:
                      return bA.sent(), z.getInstance(s.options.id).error("Error loading background-image " + B), [3, 4];
                    case 4:
                      return c && (u = e2(r, e, [
                        c.width,
                        c.height,
                        c.width / c.height
                      ]), H = u[0], q = u[1], $ = u[2], y = u[3], b = u[4], x = s.ctx.createPattern(s.resizeImage(c, y, b), "repeat"), s.renderRepeat(H, x, q, $)), [3, 6];
                    case 5:
                      Fr(l) ? (h = e2(r, e, [null, null, null]), H = h[0], q = h[1], $ = h[2], y = h[3], b = h[4], U = sr(l.angle, y, b), w = U[0], p = U[1], Q = U[2], v = U[3], I = U[4], M = document.createElement("canvas"), M.width = y, M.height = b, Z = M.getContext("2d"), N = Z.createLinearGradient(p, v, Q, I), E3(l.stops, w).forEach(function(kA) {
                        return N.addColorStop(kA.stop, AA(kA.color));
                      }), Z.fillStyle = N, Z.fillRect(0, 0, y, b), y > 0 && b > 0 && (x = s.ctx.createPattern(M, "repeat"), s.renderRepeat(H, x, q, $))) : xr(l) && (K = e2(r, e, [
                        null,
                        null,
                        null
                      ]), H = K[0], j = K[1], m = K[2], y = K[3], b = K[4], gA = l.position.length === 0 ? [G2] : l.position, q = S(gA[0], y), $ = S(gA[gA.length - 1], b), KA = Cr(l, q, $, y, b), nA = KA[0], t4 = KA[1], nA > 0 && nA > 0 && (E4 = s.ctx.createRadialGradient(j + q, m + $, 0, j + q, m + $, nA), E3(l.stops, nA * 2).forEach(function(kA) {
                        return E4.addColorStop(kA.stop, AA(kA.color));
                      }), s.path(H), s.ctx.fillStyle = E4, nA !== t4 ? (RA = r.bounds.left + 0.5 * r.bounds.width, WA = r.bounds.top + 0.5 * r.bounds.height, F4 = t4 / nA, x4 = 1 / F4, s.ctx.save(), s.ctx.translate(RA, WA), s.ctx.transform(1, 0, 0, F4, 0, 0), s.ctx.translate(-RA, -WA), s.ctx.fillRect(j, x4 * (m - WA) + WA, y, b * x4), s.ctx.restore()) : s.ctx.fill())), bA.label = 6;
                    case 6:
                      return e--, [
                        2
                        /*return*/
              ...
              }, s = this, C = 0, o = r.styles.backgroundImage.slice(0).reverse(), i.label = 1;
            case 1:
              return C < o.length ? (a = o[C], [5, n(a)]) : [3, 4];
            case 2:
              i.sent(), i.label = 3;
            case 3:
              return C++, [3, 1];
      ...
      return aA(this, void 0, void 0, function() {
        return CA(this, function(s) {
          return this.path(K0(n, e)), this.ctx.fillStyle = AA(r), this.ctx.fill(), [
            2
            /*return*/
          ];
        });
          ...
          switch (B.label) {
            case 0:
              return this.applyEffects(
                ...
                2
                /* BACKGROUND_BORDERS */
              ), e = r.container.styles, n = !VA(e.backgroundColor) || e.backgroundImage.length, s = [
              ...
              ], C = L0(u4(e.backgroundClip, 0), r.curves), n || e.boxShadow.length ? (this.ctx.save(), this.path(C), this.ctx.clip(), VA(e.backgroundColor) || (this.ctx.fillStyle = AA(e.backgroundColor), this.ctx.fill()), [4, this.renderBackgroundImage(r.container)]) : [3, 2];
            case 1:
              B.sent(), this.ctx.restore(), e.boxShadow.slice(0).reverse().forEach(function(u) {
                c.ctx.save();
                var h = K1(r.curves), U = u.inset ? 0 : S0, w = x0(h, -U + (u.inset ? 1 : -1) * u.spread.number, (u.inset ? 1 : -1) * u.spread.number, u.spread.number * (u.inset ? -2 : 2), u.spread.number * (u.inset ? -2 : 2));
                u.inset ? (c.path(h), c.ctx.clip(), c.mask(w)) : (c.mask(h), c.ctx.clip(), c.path(w)), c.ctx.shadowOffsetX = u.offsetX.number + U, c.ctx.shadowOffsetY = u.offsetY.number, c.ctx.shadowColor = AA(u.color), c.ctx.shadowBlur = u.blur.number, c.ctx.fillStyle = u.inset ? AA(u.color) : "rgba(0,0,0,1)", c.ctx.fill(), c.ctx.restore();
              }), B.label = 2;
            case 2:
              o = 0, a = 0, i = s, B.label = 3;
            case 3:
              return a < i.length ? (l = i[a], l.style !== w4.NONE && !VA(l.color) ? [4, this.renderBorder(l.color, o, r.curves)] : [3, 5]) : [3, 7];
            case 4:
              B.sent(), B.label = 5;
            case 5:
              o++, B.label = 6;
      ...
      return aA(this, void 0, void 0, function() {
        ...
        return CA(this, function(n) {
          switch (n.label) {
            case 0:
              return this.options.backgroundColor && (this.ctx.fillStyle = AA(this.options.backgroundColor), this.ctx.fillRect(this.options.x - this.options.scrollX, this.options.y - this.options.scrollY, this.options.width, this.options.height)), e = I0(r), [4, this.renderStack(e)];
            case 1:
  ...
  return A instanceof u6 || A instanceof B6 ? !0 : A instanceof z2 && A.type !== N1 && A.type !== M1;
}, L0 = function(A, r) {
  switch (A) {
    case dA.BORDER_BOX:
      return K1(r);
    ...
    return A.prototype.render = function(r) {
      return aA(this, void 0, void 0, function() {
        ...
        return CA(this, function(s) {
          switch (s.label) {
            case 0:
              return e = w2(Math.max(this.options.windowWidth, this.options.width) * this.options.scale, Math.max(this.options.windowHeight, this.options.height) * this.options.scale, this.options.scrollX * this.options.scale, this.options.scrollY * this.options.scale, r), [4, z0(e)];
            case 1:
              return n = s.sent(), this.options.backgroundColor && (this.ctx.fillStyle = AA(this.options.backgroundColor), this.ctx.fillRect(0, 0, this.options.width * this.options.scale, this.options.height * this.options.scale)), this.ctx.drawImage(n, -this.options.x * this.options.scale, -this.options.y * this.options.scale), [2, this.canvas];
          }
        });
      });
    }, A;
...
}, P0 = void 0, t2 = function(A) {
  return NA.parse(T2.create(A).parseComponentValue());
}, X0 = function(A, r) {
  return r === void 0 && (r = {}), W0(A, r);
};
typeof window < "u" && HA.setContext(window);
var W0 = function(A, r) {
  return aA(P0, void 0, void 0, function() {
    var e, n, s, C, o, a, i, l, c, B, u, h, U, w, p, Q, v, I, M, Z, N, x, K, j, H, j;
    return CA(this, function(m) {
      switch (m.label) {
        case 0:
          ...
          return s = (Math.round(Math.random() * 1e3) + Date.now()).toString(16), C = P2(A) || i0(A) ? h8(e) : S2(A), o = C.width, a = C.height, i = C.left, l = C.top, c = {
            allowTaint: !1,
            imageTimeout: 15e3,
            proxy: void 0,
            useCORS: !1
            ...
            cache: r.cache ? r.cache : HA.create(s, B),
            logging: !0,
            removeContainer: !0,
            ...
            height: Math.ceil(a),
            id: s
          }, h = g1({}, u, B, r), U = new zA(h.scrollX, h.scrollY, h.windowWidth, h.windowHeight), z.create({ id: s, enabled: h.logging }), z.getInstance(s).debug("Starting document clone"), w = new O3(A, {
            id: s,
            onclone: h.onclone,
            ignoreElements: h.ignoreElements,
            inlineImages: h.foreignObjectRendering,
            copyStyles: h.foreignObjectRendering
          }), p = w.clonedReferenceElement, p ? [4, w.toIFrame(e, U)] : [2, Promise.reject("Unable to find element in cloned iframe")];
        case 1:
          return Q = m.sent(), v = e.documentElement ? t2(getComputedStyle(e.documentElement).backgroundColor) : xA.TRANSPARENT, I = e.body ? t2(getComputedStyle(e.body).backgroundColor) : xA.TRANSPARENT, M = r.backgroundColor, Z = typeof M == "string" ? t2(M) : M === null ? xA.TRANSPARENT : 4294967295, N = A === e.documentElement ? VA(v) ? VA(I) ? Z : I : v : Z, x = {
            id: s,
            cache: h.cache,
            canvas: h.canvas,
            backgroundColor: N,
          ...
          }, h.foreignObjectRendering ? (z.getInstance(s).debug("Document cloned, using foreign object rendering"), j = new V0(x), [4, j.render(p)]) : [3, 3];
        case 2:
          return K = m.sent(), [3, 5];
        case 3:
          return z.getInstance(s).debug("Document cloned, using computed rendering"), HA.attachInstance(h.cache), z.getInstance(s).debug("Starting DOM parsing"), H = Q6(p), HA.detachInstance(), N === H.styles.backgroundColor && (H.styles.backgroundColor = xA.TRANSPARENT), z.getInstance(s).debug("Starting renderer"), j = new D0(x), [4, j.render(H)];
        case 4:
          K = m.sent(), m.label = 5;
        case 5:
          return h.removeContainer === !0 && (O3.destroy(Q) || z.getInstance(s).error("Cannot detach cloned iframe as it is not in the DOM anymore")), z.getInstance(s).debug("Finished rendering"), z.destroy(s), HA.destroy(s), [2, K];
      }
    });
  });
};
const k0 = "SiteResponseType", J0 = e7({
  dataType: k0,
  path: "/site/"
}), rA = (A, r) => {
  const e = parseInt(A.slice(1, 3), 16), n = parseInt(A.slice(3, 5), 16), s = parseInt(A.slice(5, 7), 16);
  return `rgba(${e}, ${n}, ${s}, ${r})`;
}, M2 = t7(({
  isScreenshot: A = !1,
  format: r = "vertical",
  ...
  const [B, u] = eA(!1), h = G(null);
  P(() => () => {
    h.current && window.clearTimeout(h.current);
  }, []);
  const U = async () => {
    var H;
    if (!(e != null && e.handle) || !((H = navigator == null ? void 0 : navigator.clipboard) != null && H.writeText)) {
      d4.error("Unable to copy handle");
      return;
    }
    try {
      await navigator.clipboard.writeText(e.handle), u(!0), d4.success("Handle copied"), h.current && window.clearTimeout(h.current), h.current = window.setTimeout(() => u(!1), 2e3);
    } catch {
      d4.error("Failed to copy handle"), u(!1);
    }
  }, w = () => {
    switch (l) {
      case "light":
  ...
  }, Q = w(), v = p(), I = A ? "m-12" : "m-16 max-sm:m-8", M = A ? "" : "shadow-xl", Z = r === "square" ? "w-[422px]" : "w-[316px]", N = "h-[422px]", x = A && s ? s : (e == null ? void 0 : e.bannerImageUrl) || o, K = A && C ? C : (e == null ? void 0 : e.avatarUrl) || a;
  return /* @__PURE__ */ t.jsxs("div", { className: `relative z-20 flex flex-col ${I} ${Z} ${N} rounded-[32px] ${M} ${r === "square" ? "flex flex-col" : ""}`, style: { backgroundColor: Q }, children: [
    /* @__PURE__ */ t.jsxs("div", { className: "relative h-48 p-2", children: [
      ...
      ) : /* @__PURE__ */ t.jsx("div", { className: "relative size-full overflow-hidden rounded-[26px] rounded-b-none", style: { background: `linear-gradient(to bottom, ${rA(l === "accent" ? "#ffffff" : c || "#15171a", 1)}, ${rA(l === "accent" ? "#ffffff" : c || "#15171a", 0.5)})` }, children: /* @__PURE__ */ t.jsx(a2, { className: "absolute", style: { color: l === "accent" ? rA(c || "#15171a", 0.2) : "rgba(255, 255, 255, 0.2)", top: A ? "-42px" : "-84px", left: A ? "-69px" : "-138px" } }) }),
      K && /* @__PURE__ */ t.jsx("div", { className: "absolute bottom-0 left-1/2 -mb-8 -translate-x-1/2 rounded-full border-8 [&>div]:!size-16 [&_img]:!size-16", style: { borderColor: Q }, children: /* @__PURE__ */ t.jsx(
        s7,
        {
          author: {
            icon: {
    ...
    /* @__PURE__ */ t.jsxs("div", { className: `flex grow flex-col items-center p-6 ${e != null && e.avatarUrl || a ? "pt-9" : "pt-3"} text-center ${r === "square" ? "flex-1 justify-center" : ""}`, children: [
      /* @__PURE__ */ t.jsx(z3, { className: `${A && "tracking-normal"}`, style: { color: v }, children: n ? /* @__PURE__ */ t.jsx(A3, { className: "w-32" }) : e == null ? void 0 : e.name }),
      /* @__PURE__ */ t.jsx("span", { className: `mt-1.5 leading-7 ${A && "tracking-normal"}`, style: { color: v }, children: n ? /* @__PURE__ */ t.jsx(A3, { className: "w-28" }) : "Available on Ghost, Flipboard, Threads, Bluesky, Mastodon, or wherever you get your social web feeds." }),
      /* @__PURE__ */ t.jsx(
        "div",
        {
          ...
          style: {
            color: l !== "light" ? "#fff" : c,
            borderColor: c ? rA(l === "accent" ? "#ffffff" : c, l !== "light" ? 0.7 : 0.2) : void 0,
            background: c ? `linear-gradient(to top right, ${rA(l === "accent" ? "#ffffff" : c, l === "dark" ? 0.12 : 0.04)}, ${rA(l === "accent" ? "#ffffff" : c, l === "dark" ? 0.48 : 0.16)})` : void 0
          },
          children: /* @__PURE__ */ t.jsxs("div", { className: "mb-0.5", children: [
            ...
            !A && (e == null ? void 0 : e.handle) && /* @__PURE__ */ t.jsx(
              P3,
              {
                ...
                style: { color: l !== "light" ? "#fff" : c },
                title: "Copy handle",
                variant: "link",
                onClick: U,
                children: B ? /* @__PURE__ */ t.jsx(C7, { size: 12 }) : /* @__PURE__ */ t.jsx(W3, { size: 12 })
              }
            )
          ] })
        }
...
M2.displayName = "ProfileCard";
const q0 = ({ account: A, isLoading: r }) => {
  var N, x, K, H, j;
  const { data: e } = J0(), n = (N = e == null ? void 0 : e.site) == null ? void 0 : N.accent_color, s = (x = e == null ? void 0 : e.site) == null ? void 0 : x.cover_image, C = (K = e == null ? void 0 : e.site) == null ? void 0 : K.icon, o = G(null), [a, i] = eA("light"), [l, c] = eA("vertical"), [B, u] = eA(!1), [h, U] = eA(null), [w, p] = eA(null), Q = `${A == null ? void 0 : A.name} is now available across the social web, on ${A == null ? void 0 : A.handle}`, v = lA(async () => {
    if (A != null && A.bannerImageUrl || s) {
      const m = (A == null ? void 0 : A.bannerImageUrl) || s;
      if (m) {
        const y = await $2(m);
        U(y);
      }
    }
    if (A != null && A.avatarUrl || C) {
      const m = (A == null ? void 0 : A.avatarUrl) || C;
      if (m) {
        const y = await $2(m);
        p(y);
      }
    }
  }, [A == null ? void 0 : A.bannerImageUrl, A == null ? void 0 : A.avatarUrl, s, C]);
  P(() => {
    let m = !0;
    return m && (async () => {
      await v();
  ...
  const I = () => {
    switch (a) {
      case "light":
        return `linear-gradient(to bottom left, #EBEEF0, ${rA("#EBEEF0", 0)})`;
      case "dark":
        return `linear-gradient(to bottom left, ${rA("#1A1E22", 1)}, ${rA("#343C48", 1)})`;
      case "accent":
        return `linear-gradient(to bottom left, ${rA(n || "#15171a", 0.08)}, ${rA(n || "#15171a", 0.06)})`;
      default:
        return `linear-gradient(to bottom left, #EBEEF0, ${rA("#EBEEF0", 0)})`;
    }
  }, M = () => {
    switch (a) {
      case "light":
        return rA("#15171a", 0.025);
      case "dark":
        return rA("#15171a", 0.23);
      case "accent":
    ...
    if (!(!o.current || B)) {
      ...
      try {
        ...
        try {
          const m = new Promise(async (b, gA) => {
            try {
              (await X0(o.current, {
                ...
                $ ? b($) : gA(new Error("Failed to create blob"));
              }, "image/png");
            } catch (q) {
              gA(q);
            }
          ...
          await navigator.clipboard.write([y]), d4.success("Image copied to clipboard");
        } catch {
          d4.error("Failed to copy image");
        }
        u(!1);
      } catch {
        d4.error("Failed to copy image"), u(!1);
      }
    }
  };
  return /* @__PURE__ */ t.jsx(a8, { delayDuration: 0, children: /* @__PURE__ */ t.jsxs("div", { className: "flex flex-col gap-5", children: [
    /* @__PURE__ */ t.jsxs("div", { className: "flex items-center justify-between max-sm:flex-col max-sm:items-start max-sm:gap-3", children: [
      /* @__PURE__ */ t.jsx(z3, { children: "Share your profile" }),
      /* @__PURE__ */ t.jsxs("div", { className: "flex gap-4", children: [
        /* @__PURE__ */ t.jsxs(o2, { defaultValue: "light", type: "single", value: a, onValueChange: (m) => {
          m && i(m);
        }, children: [
          /* @__PURE__ */ t.jsxs(v4, { children: [
            /* @__PURE__ */ t.jsx(M4, { children: /* @__PURE__ */ t.jsx(c4, { "aria-label": "Light", value: "light", children: /* @__PURE__ */ t.jsx("div", { className: "size-4 rounded-full border border-gray-500 dark:border-0 dark:bg-white" }) }) }),
            /* @__PURE__ */ t.jsx(i4, { children: "Light" })
          ] }),
          /* @__PURE__ */ t.jsxs(v4, { children: [
            /* @__PURE__ */ t.jsx(M4, { children: /* @__PURE__ */ t.jsx(c4, { "aria-label": "Dark", value: "dark", children: /* @__PURE__ */ t.jsx("div", { className: "size-4 rounded-full bg-black dark:border dark:border-gray-700 dark:bg-transparent" }) }) }),
            /* @__PURE__ */ t.jsx(i4, { children: "Dark" })
          ] }),
          /* @__PURE__ */ t.jsxs(v4, { children: [
            /* @__PURE__ */ t.jsx(M4, { children: /* @__PURE__ */ t.jsx(c4, { "aria-label": "Accent color", value: "accent", children: /* @__PURE__ */ t.jsx("div", { className: "size-4 rounded-full", style: { backgroundColor: n } }) }) }),
            /* @__PURE__ */ t.jsx(i4, { children: "Accent color" })
          ] })
        ] }),
        /* @__PURE__ */ t.jsxs(o2, { defaultValue: "vertical", type: "single", value: l, onValueChange: (m) => {
          m && c(m);
        }, children: [
          /* @__PURE__ */ t.jsxs(v4, { children: [
            /* @__PURE__ */ t.jsx(M4, { children: /* @__PURE__ */ t.jsx(c4, { "aria-label": "Vertical", value: "vertical", children: /* @__PURE__ */ t.jsx(U7, { className: "size-4" }) }) }),
            /* @__PURE__ */ t.jsx(i4, { children: "Vertical" })
          ] }),
          /* @__PURE__ */ t.jsxs(v4, { children: [
            /* @__PURE__ */ t.jsx(M4, { children: /* @__PURE__ */ t.jsx(c4, { "aria-label": "Square", value: "square", children: /* @__PURE__ */ t.jsx(g7, { className: "size-4" }) }) }),
            /* @__PURE__ */ t.jsx(i4, { children: "Square" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ t.jsxs("div", { className: "relative flex flex-col items-center overflow-hidden rounded-2xl bg-gray-50", children: [
      /* @__PURE__ */ t.jsx(
        M2,
        {
          ...
          isLoading: r,
          publicationIcon: C,
          siteTitle: (H = e == null ? void 0 : e.site) == null ? void 0 : H.title
        }
      ),
      /* @__PURE__ */ t.jsxs("div", { className: "relative z-20 flex w-full items-center justify-between gap-4 px-6 pb-6 max-sm:mt-4 max-sm:flex-col", children: [
        /* @__PURE__ */ t.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ t.jsx("a", { className: "flex h-[34px] w-10 items-center justify-center rounded-sm bg-white px-3 shadow-xs hover:bg-gray-50 [&_svg]:size-4", href: `https://twitter.com/intent/tweet?text=${encodeURIComponent(Q)}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ t.jsx("svg", { "aria-hidden": "true", viewBox: "0 0 24 24", children: /* @__PURE__ */ t.jsx("path", { className: "social-x_svg__x", d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" }) }) }),
          /* @__PURE__ */ t.jsx("a", { className: "flex h-[34px] w-10 items-center justify-center rounded-sm bg-white px-3 shadow-xs hover:bg-gray-50 [&_svg]:size-4", href: `https://threads.net/intent/post?text=${encodeURIComponent(Q)}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ t.jsxs("svg", { fill: "none", viewBox: "0 0 18 18", children: [
          ...
          /* @__PURE__ */ t.jsx("a", { className: "flex h-[34px] w-10 items-center justify-center rounded-sm bg-white px-3 shadow-xs hover:bg-gray-50 [&_svg]:size-4", href: `http://www.linkedin.com/shareArticle?mini=true&title=${encodeURIComponent(Q)}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ t.jsxs("svg", { fill: "none", viewBox: "0 0 16 16", children: [
        ...
        /* @__PURE__ */ t.jsxs(P3, { className: `min-w-[160px] dark:bg-black dark:text-white dark:hover:bg-black/90 ${a === "dark" && "bg-white text-black hover:bg-gray-50 dark:bg-white dark:text-black dark:hover:bg-gray-50/90"}`, onClick: Z, children: [
          B ? /* @__PURE__ */ t.jsx(n7, { color: `${a === "dark" ? "dark" : "light"}`, size: "sm" }) : /* @__PURE__ */ t.jsx(W3, {}),
          !B && "Copy image"
        ] })
      ] }),
      ((A == null ? void 0 : A.bannerImageUrl) || s) && /* @__PURE__ */ t.jsx(a2, { className: `absolute left-1/2 top-1/2 h-[600px] w-[598px] -translate-x-1/2 -translate-y-1/2 ${a === "dark" && "z-10"}`, style: { color: M() } }),
      /* @__PURE__ */ t.jsx("div", { className: "absolute inset-0", style: { background: I() } })
    ] }),
    /* @__PURE__ */ t.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ t.jsx(
            M2,
            {
              ...
              isScreenshot: !0,
              publicationIcon: C,
              siteTitle: (j = e == null ? void 0 : e.site) == null ? void 0 : j.title
            }
          ),
          ((A == null ? void 0 : A.bannerImageUrl) || s) && /* @__PURE__ */ t.jsx(a2, { className: `absolute left-[-62.5px] top-[-44px] h-[600px] w-[598px] ${a === "dark" && "z-10"}`, style: { color: M() } }),
          /* @__PURE__ */ t.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ t.jsx("img", { className: "absolute left-1/2 top-12 mt-0.5 max-w-none -translate-x-1/2", src: l === "square" ? d8 : f8, style: { width: l === "square" ? "572px" : "466px" } })
        ]
      }
    )
  ] }) });
}, rt = () => {
  const { data: A, isLoading: r, error: e } = o7("index", "me");
  return e && a7(e) ? /* @__PURE__ */ t.jsx(l7, { errorCode: e.code, statusCode: e.statusCode }) : /* @__PURE__ */ t.jsx(i7, { children: /* @__PURE__ */ t.jsxs("div", { className: "mx-auto max-w-[620px] py-[min(4vh,48px)]", children: [
    /* @__PURE__ */ t.jsx(q0, { account: A, isLoading: r }),
    /* @__PURE__ */ t.jsx(f7, { account: A, className: "mt-9" })
  ] }) });
};
export {
  rt as default
};
//# sourceMappingURL=index-DjALq0MK.mjs.map
